...
final class TestTemperatureGaugeImplWithAccessChecking extends TestTemperatureGaugeImpl
{
    TestTemperatureGaugeImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.testmodels.hierarchy.TestInstrumentPanel<?> testinstrumentpanel)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(TestTemperatureGaugeImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return TestTemperatureGaugeImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(TestTemperatureGaugeImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

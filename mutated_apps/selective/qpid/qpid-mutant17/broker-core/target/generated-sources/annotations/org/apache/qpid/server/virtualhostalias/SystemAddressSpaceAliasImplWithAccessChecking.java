...
final class SystemAddressSpaceAliasImplWithAccessChecking extends SystemAddressSpaceAliasImpl
{
    SystemAddressSpaceAliasImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.Port port)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(SystemAddressSpaceAliasImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return SystemAddressSpaceAliasImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(SystemAddressSpaceAliasImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

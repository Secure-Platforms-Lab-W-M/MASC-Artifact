...
final class VirtualHostSyslogLoggerImplWithAccessChecking extends VirtualHostSyslogLoggerImpl
{
    VirtualHostSyslogLoggerImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.VirtualHost<?> virtualhost)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(VirtualHostSyslogLoggerImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return VirtualHostSyslogLoggerImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(VirtualHostSyslogLoggerImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

...
final class TestDigitalInstrumentPanelImplWithAccessChecking extends TestDigitalInstrumentPanelImpl
{
    TestDigitalInstrumentPanelImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.testmodels.hierarchy.TestCar<?> testcar)
    {
        super(attributes, testcar);
    }
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(TestDigitalInstrumentPanelImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return TestDigitalInstrumentPanelImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(TestDigitalInstrumentPanelImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

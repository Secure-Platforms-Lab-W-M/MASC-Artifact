...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhost.BDB_HA"))
        {
             implementations.add(BDBHAVirtualHostImpl.class);
        }
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhost.BDB"))
        {
             implementations.add(BDBVirtualHostImpl.class);
        }
    ...
    {
        return "org.apache.qpid.server.virtualhost.berkeleydb";
    }

...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhostnode.JDBC"))
        {
             implementations.add(JDBCVirtualHostNodeImpl.class);
        }
    ...
    {
        return "org.apache.qpid.server.virtualhostnode.jdbc";
    }

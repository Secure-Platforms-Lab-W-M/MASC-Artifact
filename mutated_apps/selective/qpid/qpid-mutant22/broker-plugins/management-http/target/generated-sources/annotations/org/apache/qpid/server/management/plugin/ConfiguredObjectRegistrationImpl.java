...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:plugin.MANAGEMENT-HTTP"))
        {
             implementations.add(HttpManagement.class);
        }
    ...
    {
        return "org.apache.qpid.server.management.plugin";
    }

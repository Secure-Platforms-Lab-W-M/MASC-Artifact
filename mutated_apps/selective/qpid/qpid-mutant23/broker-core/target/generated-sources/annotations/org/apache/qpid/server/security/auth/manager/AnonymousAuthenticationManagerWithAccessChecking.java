...
{
    AnonymousAuthenticationManagerWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.Container<?> container)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(AnonymousAuthenticationManagerWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return AnonymousAuthenticationManagerWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(AnonymousAuthenticationManagerWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

...
final class LastValueQueueImplWithAccessChecking extends LastValueQueueImpl
{
    LastValueQueueImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.virtualhost.QueueManagingVirtualHost<?> queuemanagingvirtualhost)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(LastValueQueueImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(LastValueQueueImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

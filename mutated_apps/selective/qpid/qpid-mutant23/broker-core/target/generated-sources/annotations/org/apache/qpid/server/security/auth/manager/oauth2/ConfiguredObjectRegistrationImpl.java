...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:authenticationprovider.OAuth2"))
        {
             implementations.add(OAuth2AuthenticationProvider.class);
        }
    ...
    {
        return "org.apache.qpid.server.security.auth.manager.oauth2";
    }

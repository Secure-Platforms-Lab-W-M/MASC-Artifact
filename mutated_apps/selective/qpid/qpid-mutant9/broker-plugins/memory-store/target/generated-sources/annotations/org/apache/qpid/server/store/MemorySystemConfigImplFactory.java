...
{
    public MemorySystemConfigImplFactory()
    {
    }
    ...
    @Override
    public MemorySystemConfigImpl newInstance(final TaskExecutor taskExecutor,
                       final EventLogger eventLogger,
                       final Principal systemPrincipal,
                       final Map<String,Object> attributes)
    {
        return new MemorySystemConfigImpl(taskExecutor, eventLogger, systemPrincipal, attributes);
    }
}

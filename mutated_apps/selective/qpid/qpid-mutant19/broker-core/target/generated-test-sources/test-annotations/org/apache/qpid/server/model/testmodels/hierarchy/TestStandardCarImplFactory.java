...
public final class TestStandardCarImplFactory extends AbstractConfiguredObjectTypeFactory<TestStandardCarImpl>
{
    ...
    @Override
    protected TestStandardCarImpl createInstance(final Map<String, Object> attributes, final ConfiguredObject<?> parent)
    {
        return new TestStandardCarImplWithAccessChecking(attributes);
    }
}

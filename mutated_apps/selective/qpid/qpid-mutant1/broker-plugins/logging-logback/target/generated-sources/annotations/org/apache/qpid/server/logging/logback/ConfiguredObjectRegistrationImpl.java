...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhostloginclusionrule.NameAndLevel"))
        {
             implementations.add(VirtualHostNameAndLevelLogInclusionRule.class);
        }
        if(!Boolean.getBoolean("qpid.type.disabled:brokerloginclusionrule.NameAndLevel"))
        {
             implementations.add(BrokerNameAndLevelLogInclusionRule.class);
        }
    ...
    {
        return "org.apache.qpid.server.logging.logback";
    }

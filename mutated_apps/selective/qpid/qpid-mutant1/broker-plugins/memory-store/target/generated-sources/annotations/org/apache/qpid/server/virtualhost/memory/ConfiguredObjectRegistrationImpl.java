...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhost.Memory"))
        {
             implementations.add(MemoryVirtualHost.class);
        }
    ...
    {
        return "org.apache.qpid.server.virtualhost.memory";
    }

...
final class TopicExchangeImplWithAccessChecking extends TopicExchangeImpl
{
    TopicExchangeImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.virtualhost.QueueManagingVirtualHost<?> queuemanagingvirtualhost)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(TopicExchangeImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return TopicExchangeImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(TopicExchangeImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.bind(destination, bindingKey, arguments, replaceExistingArguments));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.unbind(destination, bindingKey));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    try
                    {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.addBinding(bindingKey, queue, arguments));
                    }
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.deleteBinding(bindingKey, queue));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.hasBinding(bindingKey, queue));
                }
                @Override
                public String getObject()
                {
        ...
        doSync(doOnConfigThread(new Task<ListenableFuture<Void>, RuntimeException>()
            {
                ...
                public ListenableFuture<Void> execute()
                {
                    try
                    {
                    TopicExchangeImplWithAccessChecking.super.replaceBinding(bindingKey, queue, arguments);
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.isBound(bindingKey, arguments, queue));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(TopicExchangeImplWithAccessChecking.super.hasBindings());
                }
                @Override
                public String getObject()
                {
        ...
        doSync(doOnConfigThread(new Task<ListenableFuture<Void>, RuntimeException>()
            {
                ...
                public ListenableFuture<Void> execute()
                {
                    TopicExchangeImplWithAccessChecking.super.destinationRemoved(destination);
                    return Futures.<Void>immediateFuture(null);
                }
                @Override
                public String getObject()

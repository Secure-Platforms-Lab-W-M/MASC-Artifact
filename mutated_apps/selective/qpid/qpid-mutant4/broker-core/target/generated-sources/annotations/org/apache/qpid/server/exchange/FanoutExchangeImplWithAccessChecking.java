...
final class FanoutExchangeImplWithAccessChecking extends FanoutExchangeImpl
{
    FanoutExchangeImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.virtualhost.QueueManagingVirtualHost<?> queuemanagingvirtualhost)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(FanoutExchangeImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(FanoutExchangeImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.bind(destination, bindingKey, arguments, replaceExistingArguments));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.unbind(destination, bindingKey));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    try
                    {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.addBinding(bindingKey, queue, arguments));
                    }
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.deleteBinding(bindingKey, queue));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.hasBinding(bindingKey, queue));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.isBound(bindingKey, arguments, queue));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.Boolean>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.Boolean> execute()
                {
                    return Futures.<java.lang.Boolean>immediateFuture(FanoutExchangeImplWithAccessChecking.super.hasBindings());
                }
                @Override
                public String getObject()
                {

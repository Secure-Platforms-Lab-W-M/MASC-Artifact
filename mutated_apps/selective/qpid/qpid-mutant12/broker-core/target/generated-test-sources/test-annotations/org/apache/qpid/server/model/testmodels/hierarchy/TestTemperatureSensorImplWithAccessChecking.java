...
final class TestTemperatureSensorImplWithAccessChecking extends TestTemperatureSensorImpl
{
    TestTemperatureSensorImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.testmodels.hierarchy.TestInstrumentPanel<?> testinstrumentpanel)
    {
        super(attributes, testinstrumentpanel);
    }
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(TestTemperatureSensorImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return TestTemperatureSensorImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(TestTemperatureSensorImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {

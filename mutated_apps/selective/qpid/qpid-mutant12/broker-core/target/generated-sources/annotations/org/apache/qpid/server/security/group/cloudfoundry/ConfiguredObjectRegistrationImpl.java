...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:groupprovider.CloudFoundryDashboardManagement"))
        {
             implementations.add(CloudFoundryDashboardManagementGroupProvider.class);
        }
    ...
    {
        return "org.apache.qpid.server.security.group.cloudfoundry";
    }

...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhostnode.DERBY"))
        {
             implementations.add(DerbyVirtualHostNodeImpl.class);
        }
    ...
    {
        return "org.apache.qpid.server.virtualhostnode.derby";
    }

...
final class MemoryVirtualHostWithAccessChecking extends MemoryVirtualHost
{
    MemoryVirtualHostWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.VirtualHostNode<?> virtualhostnode)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(MemoryVirtualHostWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return MemoryVirtualHostWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(MemoryVirtualHostWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<org.apache.qpid.server.model.Queue<?>>, RuntimeException>()
            {
                ...
                {
                    return Futures.<org.apache.qpid.server.model.Queue<?>>immediateFuture(MemoryVirtualHostWithAccessChecking.super.getSubscriptionQueue(exchangeName, attributes, bindings));
                }
                @Override
                public String getObject()
                {
        ...
        doSync(doOnConfigThread(new Task<ListenableFuture<Void>, RuntimeException>()
            {
                ...
                public ListenableFuture<Void> execute()
                {
                    try
                    {
                    MemoryVirtualHostWithAccessChecking.super.removeSubscriptionQueue(queueName);

...
{
    BrokerMemoryLoggerImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.Broker<?> broker)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(BrokerMemoryLoggerImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(BrokerMemoryLoggerImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {
    ...
    private static final FixedKeyMapCreator GET_LOG_ENTRIES_MAP_CREATOR = new FixedKeyMapCreator("lastLogId");

    public java.util.Collection<org.apache.qpid.server.logging.logback.LogRecord> getLogEntries(final long lastLogId)
    {
        authorise(INVOKE_METHOD("getLogEntries"), GET_LOG_ENTRIES_MAP_CREATOR.createMap(lastLogId));

        return super.getLogEntries(lastLogId);
    }

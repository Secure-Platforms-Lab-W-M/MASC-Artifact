...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:brokerlogger.JDBC"))
        {
             implementations.add(JDBCBrokerLoggerImpl.class);
        }
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhostlogger.JDBC"))
        {
             implementations.add(JDBCVirtualHostLoggerImpl.class);
        }
    ...
    {
        return "org.apache.qpid.server.logging.logback.jdbc";
    }

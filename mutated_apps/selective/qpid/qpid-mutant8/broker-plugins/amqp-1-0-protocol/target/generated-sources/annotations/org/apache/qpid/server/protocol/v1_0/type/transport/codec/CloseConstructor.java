...
public final class CloseConstructor extends AbstractCompositeTypeConstructor<Close>
{
    private static final CloseConstructor INSTANCE = new CloseConstructor();

    public static void register(DescribedTypeConstructorRegistry registry)
    {
        registry.register(Symbol.valueOf("amqp:close:list"), INSTANCE);
        registry.register(UnsignedLong.valueOf(0x00000000000018), INSTANCE);
    }

    @Override
    protected String getTypeName()
    {
        return Close.class.getSimpleName();
    }

    @Override
    protected Close construct(final FieldValueReader fieldValueReader) throws AmqpErrorException
    {
        Close obj = new Close();

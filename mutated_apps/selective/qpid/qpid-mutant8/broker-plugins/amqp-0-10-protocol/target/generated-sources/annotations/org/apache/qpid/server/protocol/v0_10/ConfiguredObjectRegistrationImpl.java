...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:connection.AMQP_0_10"))
        {
             implementations.add(AMQPConnection_0_10.class);
        }
    ...
    {
        return "org.apache.qpid.server.protocol.v0_10";
    }

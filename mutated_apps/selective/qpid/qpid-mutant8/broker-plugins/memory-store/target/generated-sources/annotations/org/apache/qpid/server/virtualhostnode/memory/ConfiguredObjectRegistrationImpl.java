...
public class ConfiguredObjectRegistrationImpl implements ConfiguredObjectRegistration
{
    ...
    public ConfiguredObjectRegistrationImpl()
    {
        ...
        if(!Boolean.getBoolean("qpid.type.disabled:virtualhostnode.Memory"))
        {
             implementations.add(MemoryVirtualHostNode.class);
        }
    ...
    {
        return "org.apache.qpid.server.virtualhostnode.memory";
    }

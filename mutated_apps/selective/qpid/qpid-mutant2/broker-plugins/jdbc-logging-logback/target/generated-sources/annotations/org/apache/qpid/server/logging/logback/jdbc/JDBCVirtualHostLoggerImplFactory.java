...
public final class JDBCVirtualHostLoggerImplFactory extends AbstractConfiguredObjectTypeFactory<JDBCVirtualHostLoggerImpl>
{
    ...
    @Override
    protected JDBCVirtualHostLoggerImpl createInstance(final Map<String, Object> attributes, final ConfiguredObject<?> parent)
    {
        return new JDBCVirtualHostLoggerImplWithAccessChecking(attributes, (org.apache.qpid.server.model.VirtualHost)parent);
    }
}

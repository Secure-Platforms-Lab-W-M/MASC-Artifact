...
final class FileTrustStoreImplWithAccessChecking extends FileTrustStoreImpl
{
    FileTrustStoreImplWithAccessChecking(final Map<String, Object> attributes, final org.apache.qpid.server.model.Broker<?> broker)
    {
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                {
                    return Futures.<java.lang.String>immediateFuture(FileTrustStoreImplWithAccessChecking.super.setContextVariable(name, value));
                }
                @Override
                public String getObject()
                {
                    return FileTrustStoreImplWithAccessChecking.this.toString();
                }
                @Override
        ...
        return doSync(doOnConfigThread(new Task<ListenableFuture<java.lang.String>, RuntimeException>()
            {
                ...
                public ListenableFuture<java.lang.String> execute()
                {
                    return Futures.<java.lang.String>immediateFuture(FileTrustStoreImplWithAccessChecking.super.removeContextVariable(name));
                }
                @Override
                public String getObject()
                {
    ...
    public void reload()
    {
        authorise(INVOKE_METHOD("reload"));
        ...
        doSync(doOnConfigThread(new Task<ListenableFuture<Void>, RuntimeException>()
            {
                ...
                {
                    FileTrustStoreImplWithAccessChecking.super.reload();

...
MessageDigest cryptoDigest;
    ...
    public static byte[] serialize(BigInteger[] ints)
            throws SMException
    {
        try {
    ...
    public static BigInteger[] unserialize(byte[] bytes)
            throws SMException
    {
        try {
     ...
     * or greater than {@code c}.
     * @throws SMException when something goes wrong
     */
    public static int checkKnowLog(BigInteger c, BigInteger d, BigInteger g, BigInteger x, int version)
            throws SMException
    {
     ...
     * @throws SMException MVN_PASS_JAVADOC_INSPECTION
     */
    public static int checkEqualLogs(BigInteger c, BigInteger d, BigInteger r, SMState state, int version)
            throws SMException
    {
     ...
     * @throws SMException MVN_PASS_JAVADOC_INSPECTION
     */
    public static byte[] step1(SMState astate, byte[] secret)
            throws SMException
    {
     ...
     * @throws SMException MVN_PASS_JAVADOC_INSPECTION
     */
    public static void step2a(SMState bstate, byte[] input, int receivedQuestion)
            throws SMException
    {

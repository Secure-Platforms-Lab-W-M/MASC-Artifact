```
Analyzing APK: /media/data/muse2/muse2repo_personaldns/apks/personal_dns3.apk
*** Base package: dnsfilter.android
=======================================
***Violated Rule 1: Found broken crypto schemes ***Constants: ["AES"]
[UnitContainer{unit=$r2 = "AES", method='<util.Encryption: void init_AES(java.lang.String)>'}]
=======================================
=======================================
***Violated Rule 1a: Found broken crypto schemes ***Constants: ["Using Directory: ", "server_remote_ctrl_keyphrase", "", 0, "server_remote_ctrl_port", "-1", 0, "AES/CBC/PKCS5Padding", "de$s", "des", "AES/CBC/PKCS5Padding", 1, "", 0, 0, 16, 0, "$", "", 0, "des", "A", "D", 1, ""]
=======================================
=============================================

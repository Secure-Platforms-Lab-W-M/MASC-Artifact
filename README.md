...
We are actively enhancing MASC after our oakland paper to make it better in terms of maintainability and extensibility. While the oakland22 branch reflects the then submitted artifact, the main branch comes with several fixes and enhancements for better readability and extensions. Furthermore, the MASC framework is actively being maintained at the https://github.com/Secure-Platforms-Lab-W-M/MASC repository. 

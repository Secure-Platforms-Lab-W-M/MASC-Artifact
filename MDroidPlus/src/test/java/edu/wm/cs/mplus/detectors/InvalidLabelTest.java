...
import edu.wm.cs.mplus.operators.activity.InvalidLabel;

public class InvalidLabelTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//Run Detector
		InvalidLabelDetector detector = new InvalidLabelDetector();
		...
		InvalidLabel operator = new InvalidLabel();

...
public class ExhaustiveTest {
	...
	String rootPath = System.getProperty("user.dir") + "\\src\\test\\java\\masc\\edu\\wm\\cs\\masc\\muse\\";
	...
	// Muse output is written to this file in each test, and compared to the expected output.
	...
	private void prepare_test_files() throws FileNotFoundException, IOException {
	...
	private void execute_muse() throws BadLocationException, MalformedTreeException, IOException {
		Arguments.setTestMode(true);
		rewriter = ASTRewrite.create(root.getAST());
		sourceDoc = new Document(content);
		MuseRunner.operatorExecution(root, rewriter, sourceDoc.get(),output, "System.out.println(\"This is a mutation\");");

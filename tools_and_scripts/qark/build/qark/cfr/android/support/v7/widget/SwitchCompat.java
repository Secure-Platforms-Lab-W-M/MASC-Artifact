...
extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet object, int n) {
        ...
        resources = object.getColorStateList(R.styleable.SwitchCompat_trackTint);
        if (resources != null) {
        ...
        if (drawable3 != null) {
            ...
            if (drawable2 != null) {
                if (drawable2.left > rect.left) {
                    n += drawable2.left - rect.left;
                }
                if (drawable2.top > rect.top) {
                    n5 += drawable2.top - rect.top;
                }
                if (drawable2.right > rect.right) {
                    n3 -= drawable2.right - rect.right;
                }
                if (drawable2.bottom > rect.bottom) {
                    n7 -= drawable2.bottom - rect.bottom;
                }
            }
            this.mTrackDrawable.setBounds(n, n5, n3, n7);
            n5 = n6;
        }
        if ((drawable2 = this.mThumbDrawable) != null) {
            drawable2.getPadding(rect);
            n3 = n5 - rect.left;
            n5 = this.mThumbWidth + n5 + rect.right;
            this.mThumbDrawable.setBounds(n3, n2, n5, n4);
            drawable2 = this.getBackground();
            if (drawable2 != null) {
                DrawableCompat.setHotspotBounds(drawable2, n3, n2, n5, n4);
            }
        }
        super.draw(canvas);
    }
    ...
    protected void drawableStateChanged() {
        ...
        if ((drawable2 = this.mTrackDrawable) != null && drawable2.isStateful()) {
            bl |= drawable2.setState(arrn);
        }
        if (bl) {
            this.invalidate();
            return;
    ...
    public void onMeasure(int n, int n2) {
        ...
        if (rect != null) {
            ...
            n5 = Math.max(n5, rect.left);
            n6 = Math.max(n6, rect.right);
        }
        n5 = Math.max(this.mSwitchMinWidth, this.mThumbWidth * 2 + n5 + n6);
        n4 = Math.max(n3, n4);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        block0 : switch (motionEvent.getActionMasked()) {
            default: {
                break;
            }
            case 2: {
                switch (this.mTouchMode) {
                    ...
                    case 2: {
                        ...
                        if ((f2 = SwitchCompat.constrain(this.mThumbPosition + f2, 0.0f, 1.0f)) != this.mThumbPosition) {
                            this.mTouchX = f;
                    ...
                    case 1: {
                        ...
                        if (Math.abs(f - this.mTouchX) <= (float)this.mTouchSlop && Math.abs(f3 - this.mTouchY) <= (float)this.mTouchSlop) break block0;
                        this.mTouchMode = 2;
            ...
            case 0: {
                ...
                if (!this.isEnabled() || !this.hitThumb(f, f4)) break;
                this.mTouchMode = 1;
                this.mTouchX = f;
                this.mTouchY = f4;
                break;
    ...
    public void setSwitchTypeface(Typeface typeface) {
        block3 : {
            block2 : {
                if (this.mTextPaint.getTypeface() != null && !this.mTextPaint.getTypeface().equals((Object)typeface)) break block2;
                if (this.mTextPaint.getTypeface() != null || typeface == null) break block3;
            }

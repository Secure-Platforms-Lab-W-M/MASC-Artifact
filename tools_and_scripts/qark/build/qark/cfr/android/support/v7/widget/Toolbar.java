...
extends ViewGroup {
    ...
    public Toolbar(Context object, @Nullable AttributeSet object2, int n) {
        ...
        n = object.getDimensionPixelOffset(R.styleable.Toolbar_titleMargin, 0);
        if (object.hasValue(R.styleable.Toolbar_titleMargins)) {
            n = object.getDimensionPixelOffset(R.styleable.Toolbar_titleMargins, n);
        }
    ...
    private int getChildTop(View view, int n) {
        ...
        if (n3 != 48) {
            if (n3 != 80) {
                ...
                } else if ((n2 = n5 - n4 - n2 - n - n3) < layoutParams.bottomMargin) {
    ...
    private void measureChildConstrained(View view, int n, int n2, int n3, int n4, int n5) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams)view.getLayoutParams();
        n2 = Toolbar.getChildMeasureSpec((int)n, (int)(this.getPaddingLeft() + this.getPaddingRight() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + n2), (int)marginLayoutParams.width);
        n = Toolbar.getChildMeasureSpec((int)n3, (int)(this.getPaddingTop() + this.getPaddingBottom() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + n4), (int)marginLayoutParams.height);
        n3 = View.MeasureSpec.getMode((int)n);
        if (n3 != 1073741824 && n5 >= 0) {
            if (n3 != 0) {
                n5 = Math.min(View.MeasureSpec.getSize((int)n), n5);
            }
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        arrn[1] = 0;
        arrn[0] = 0;
        n3 = ViewCompat.getMinimumHeight((View)this);
        n3 = n3 >= 0 ? Math.min(n3, n4 - n2) : 0;
        if (this.shouldLayout((View)this.mNavButtonView)) {
            if (n5 != 0) {
                n2 = this.layoutChildRight((View)this.mNavButtonView, n12, arrn, n3);
            } else {
                n = this.layoutChildLeft((View)this.mNavButtonView, n, arrn, n3);
                n2 = n12;
            }
        } else {
            n2 = n12;
        ...
        if (this.shouldLayout((View)this.mCollapseButtonView)) {
            if (n5 != 0) {
                n2 = this.layoutChildRight((View)this.mCollapseButtonView, n2, arrn, n3);
            } else {
                n = this.layoutChildLeft((View)this.mCollapseButtonView, n, arrn, n3);
            }
        }
        if (this.shouldLayout((View)this.mMenuView)) {
            if (n5 != 0) {
                n = this.layoutChildLeft((View)this.mMenuView, n, arrn, n3);
            } else {
                n2 = this.layoutChildRight((View)this.mMenuView, n2, arrn, n3);
            }
        }
        n12 = this.getCurrentContentInsetLeft();
        n4 = this.getCurrentContentInsetRight();
        arrn[0] = Math.max(0, n12 - n);
        arrn[1] = Math.max(0, n4 - (n6 - n9 - n2));
        n = Math.max(n, n12);
        n4 = Math.min(n2, n6 - n9 - n4);
        if (this.shouldLayout(this.mExpandedActionView)) {
            if (n5 != 0) {
                n4 = this.layoutChildRight(this.mExpandedActionView, n4, arrn, n3);
                n2 = n;
            } else {
                n2 = this.layoutChildLeft(this.mExpandedActionView, n, arrn, n3);
            }
        } else {
            n2 = n;
        }
        if (this.shouldLayout((View)this.mLogoView)) {
            if (n5 != 0) {
                n4 = this.layoutChildRight((View)this.mLogoView, n4, arrn, n3);
            } else {
                n2 = this.layoutChildLeft((View)this.mLogoView, n2, arrn, n3);
            }
        }
        ...
        if (bl2) {
            ...
            n += layoutParams.topMargin + this.mSubtitleTextView.getMeasuredHeight() + layoutParams.bottomMargin;
        }
        if (!bl && !bl2) {
            n = n2;
        } else {
            ...
            int n13 = this.mGravity & 112;
            if (n13 != 48) {
                if (n13 != 80) {
                    n13 = (n7 - n10 - n11 - n) / 2;
                    n = n13 < layoutParams.topMargin + this.mTitleMarginTop ? layoutParams.topMargin + this.mTitleMarginTop : ((n = n7 - n11 - n - n13 - n10) < layoutParams.bottomMargin + this.mTitleMarginBottom ? Math.max(0, n13 - (object.bottomMargin + this.mTitleMarginBottom - n)) : n13);
                    n = n10 + n;
                } else {
                    n = n7 - n11 - object.bottomMargin - this.mTitleMarginBottom - n;
                }
            } else {
        ...
        n3 = this.getViewListMeasuredWidth(this.mTempViews, arrn);
        n2 = n8 + (n6 - n8 - n9) / 2 - n3 / 2;
        n3 = n2 + n3;
        if (n2 >= n) {
            n = n3 > n4 ? n2 - (n3 - n4) : n2;
        }
        ...
        do {
            ...
            n3 = this.layoutChildLeft(this.mTempViews.get(n), n3, arrn, n12);
            ++n;
        } while (true);
    }
    ...
    protected void onMeasure(int n, int n2) {
        ...
        if (this.shouldLayout((View)this.mCollapseButtonView)) {
            ...
            n6 = View.combineMeasuredStates((int)n6, (int)this.mCollapseButtonView.getMeasuredState());
        }
        int n8 = this.getCurrentContentInsetStart();
        int n9 = 0 + Math.max(n8, n7);
        arrn[n4] = Math.max(0, n8 - n7);
        if (this.shouldLayout((View)this.mMenuView)) {
            this.measureChildConstrained((View)this.mMenuView, n, n9, n2, 0, this.mMaxButtonHeight);
            n4 = this.mMenuView.getMeasuredWidth();
            n8 = this.getHorizontalMargins((View)this.mMenuView);
            n5 = Math.max(n5, this.mMenuView.getMeasuredHeight() + this.getVerticalMargins((View)this.mMenuView));
            n7 = View.combineMeasuredStates((int)n6, (int)this.mMenuView.getMeasuredState());
            n6 = n5;
            n5 = n4 + n8;
        } else {
            n7 = n6;
        ...
        n9 += Math.max(n4, n5);
        arrn[n3] = Math.max(0, n4 - n5);
        if (this.shouldLayout(this.mExpandedActionView)) {
            n3 = n9 + this.measureChildCollapseMargins(this.mExpandedActionView, n, n9, n2, 0, arrn);
            n6 = Math.max(n6, this.mExpandedActionView.getMeasuredHeight() + this.getVerticalMargins(this.mExpandedActionView));
            n4 = View.combineMeasuredStates((int)n7, (int)this.mExpandedActionView.getMeasuredState());
            n7 = n3;
            n3 = n6;
        } else {
            n4 = n7;
        ...
        if (this.shouldLayout((View)this.mLogoView)) {
            n7 += this.measureChildCollapseMargins((View)this.mLogoView, n, n7, n2, 0, arrn);
            n3 = Math.max(n3, this.mLogoView.getMeasuredHeight() + this.getVerticalMargins((View)this.mLogoView));
            n6 = View.combineMeasuredStates((int)n4, (int)this.mLogoView.getMeasuredState());
        } else {
            n6 = n4;
        }
        ...
        for (n9 = 0; n9 < n3; ++n9) {
            ...
            n4 += this.measureChildCollapseMargins(view, n, n4, n2, 0, arrn);
            n5 = Math.max(n5, view.getMeasuredHeight() + this.getVerticalMargins(view));
            n6 = View.combineMeasuredStates((int)n6, (int)view.getMeasuredState());
        }
        n3 = 0;
        n7 = 0;
        ...
        if (this.shouldLayout((View)this.mTitleTextView)) {
            this.measureChildCollapseMargins((View)this.mTitleTextView, n, n4 + n8, n2, n9, arrn);
            n3 = this.mTitleTextView.getMeasuredWidth() + this.getHorizontalMargins((View)this.mTitleTextView);
        ...
        if (this.shouldLayout((View)this.mSubtitleTextView)) {
            n3 = Math.max(n3, this.measureChildCollapseMargins((View)this.mSubtitleTextView, n, n4 + n8, n2, n7 + n9, arrn));
            n9 = this.mSubtitleTextView.getMeasuredHeight();
            n8 = this.getVerticalMargins((View)this.mSubtitleTextView);
        ...
        n9 = this.getPaddingBottom();
        n3 = View.resolveSizeAndState((int)Math.max(n4 + n3 + (n8 + n10), this.getSuggestedMinimumWidth()), (int)n, (int)(-16777216 & n6));
        n = View.resolveSizeAndState((int)Math.max(n5 + (n7 + n9), this.getSuggestedMinimumHeight()), (int)n2, (int)(n6 << 16));
    ...
    public void setContentInsetEndWithActions(int n) {
        ...
        if (n != this.mContentInsetEndWithActions) {
            this.mContentInsetEndWithActions = n;
            if (this.getNavigationIcon() != null) {
                this.requestLayout();
                return;
            }
    ...
    public void setContentInsetStartWithNavigation(int n) {
        ...
        if (n != this.mContentInsetStartWithNavigation) {
            this.mContentInsetStartWithNavigation = n;
            if (this.getNavigationIcon() != null) {
                this.requestLayout();
                return;
            }
    ...
    implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder object, MenuItemImpl menuItemImpl) {
            ...
            if (object != (toolbar = Toolbar.this)) {
                object = toolbar.generateDefaultLayoutParams();
        ...
        public void updateMenuView(boolean bl) {
            if (this.mCurrentExpandedItem != null) {
                ...
                block5 : {
                    ...
                    if (menuBuilder != null) {
                        int n3 = menuBuilder.size();
                        for (n = 0; n < n3; ++n) {
                            if (this.mMenu.getItem(n) != this.mCurrentExpandedItem) continue;
                            n = 1;
                            break block5;
                        }
                        n = n2;

...
Set<E> {
    ...
    private static void freeArrays(int[] arrn, Object[] arrobject, int n) {
        block11 : {
            block12 : {
                block9 : {
                    block10 : {
                        block8 : {
                            ...
                            // MONITORENTER : androidx.collection.ArraySet.class
                ...
                // MONITOREXIT : androidx.collection.ArraySet.class
                return;
            }
            while (n >= 2) {
                arrobject[n] = null;
    ...
    public boolean add(E e) {
        ...
        if (n3 < (n2 = this.mSize)) {
            ...
            arrn = this.mArray;
            System.arraycopy(arrn, n3, arrn, n3 + 1, this.mSize - n3);
        }
        this.mHashes[n3] = n;
        this.mArray[n3] = e;
        ++this.mSize;
    ...
    public <T> T[] toArray(T[] arrT) {
        ...
        System.arraycopy(this.mArray, 0, arrT2, 0, this.mSize);
        int n = arrT2.length;
        int n2 = this.mSize;
        if (n > n2) {
            arrT2[n2] = null;

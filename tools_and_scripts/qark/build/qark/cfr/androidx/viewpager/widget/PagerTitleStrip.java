...
extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(float f) {
        int n;
        this.mNonPrimaryAlpha = n = (int)(255.0f * f) & 255;
    ...
    void updateTextPositions(int n, float f, boolean bl) {
        ...
        textView.layout(n5, n10, n3, n10 + textView.getMeasuredHeight());
        n10 = Math.min(n8, n5 - this.mScaledTextSpacing - n2);
        textView = this.mPrevText;
        textView.layout(n10, n7, n10 + n2, n7 + textView.getMeasuredHeight());

    ...
    void applyTransformation(float f, Ring ring, boolean bl) {
        ...
        if (f != 1.0f || bl) {
            ...
            if (f < 0.5f) {
                ...
                f3 = MATERIAL_INTERPOLATOR.getInterpolation(f3) * 0.79f + 0.01f + f4;
            } else {
                f4 = (f - 0.5f) / 0.5f;
                f3 = ring.getStartingStartTrim() + 0.79f;
                f2 = MATERIAL_INTERPOLATOR.getInterpolation(f4);
                f4 = f3;
                f2 = f3 - ((1.0f - f2) * 0.79f + 0.01f);
                f3 = f4;
                f4 = f2;
            }

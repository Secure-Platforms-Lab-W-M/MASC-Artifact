...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long l, int n) {
        ...
        if (n != 0) {
            ...
            n3 = n9 + TimeUtils.accumField(n7, 1, bl, 2);
            n9 = n3 > 0 ? 3 : 0;
            n3 += TimeUtils.accumField(n8, 2, true, n9) + 1;
            n9 = n11;
            do {
                n10 = n9++;
                if (n3 >= n) break;
        ...
        bl = n5 != n10;
        n9 = n != 0 ? 2 : 0;
        n5 = TimeUtils.printField(arrc, n4, 'm', n5, bl, n9);
        bl = n5 != n10 ? bl2 : false;
        n9 = n != 0 ? n3 : 0;
        n9 = TimeUtils.printField(arrc, n7, 's', n5, bl, n9);
        n = n != 0 && n9 != n10 ? n12 : 0;

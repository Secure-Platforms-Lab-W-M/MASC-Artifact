...
public class ViewDragHelper {
                        ...
                        if (n != 5) {
                            ...
                            if (this.mDragState == 1 && n3 == this.mActivePointerId) {
                                ...
                                do {
                                    ...
                                    if (n2 != this.mActivePointerId && (view = this.findTopChildUnder((int)(f2 = motionEvent.getX(n)), (int)(f = motionEvent.getY(n)))) == (view2 = this.mCapturedView) && this.tryCaptureViewForDrag(view2, n2)) {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        block18 : {
            ...
            if (((n2 = this.mInitialEdgesTouched[n12]) & (n = this.mTrackingEdges)) != 0) {

    ...
    public static class DiffResult {
                ...
                if (bl) {
                    ...
                    while (n6 >= n7 + n8) {
                        if (this.mCallback.areItemsTheSame(n6, n5)) {
                            ...
                            this.mNewItemStatuses[n5] = n6 << 5 | 16;
                            this.mOldItemStatuses[n6] = n5 << 5 | n2;
                            return true;
                        }
                        --n6;
                    }
                } else {
                    for (n6 = n4 - 1; n6 >= n9 + n10; --n6) {
                        if (!this.mCallback.areItemsTheSame(n5, n6)) continue;
                        if (!this.mCallback.areContentsTheSame(n5, n6)) {
                            n2 = 4;
                        }
                        this.mOldItemStatuses[n - 1] = n6 << 5 | 16;
                        this.mNewItemStatuses[n6] = n - 1 << 5 | n2;
                        return true;
                    }
                }
                n6 = snake.x;
        ...
        public int convertNewPositionToOld(int n) {
            if (n >= 0 && n < this.mNewListSize) {
                if (((n = this.mNewItemStatuses[n]) & 31) == 0) {
                    return -1;
                }
                return n >> 5;
            }
        ...
        public int convertOldPositionToNew(int n) {
            if (n >= 0 && n < this.mOldListSize) {
                if (((n = this.mOldItemStatuses[n]) & 31) == 0) {
                    return -1;
                }
                return n >> 5;
            }

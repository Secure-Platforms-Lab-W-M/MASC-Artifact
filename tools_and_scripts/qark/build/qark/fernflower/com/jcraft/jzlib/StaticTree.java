...
final class StaticTree {
   ...
   static {
      static_l_desc = new StaticTree(static_ltree, Tree.extra_lbits, 257, 286, 15);
      static_d_desc = new StaticTree(static_dtree, Tree.extra_dbits, 0, 30, 15);
      static_bl_desc = new StaticTree((short[])null, Tree.extra_blbits, 0, 19, 7);
   }

   private StaticTree(short[] var1, int[] var2, int var3, int var4, int var5) {
      this.static_tree = var1;
      this.extra_bits = var2;
      this.extra_base = var3;
      this.elems = var4;
      this.max_length = var5;
   }
}

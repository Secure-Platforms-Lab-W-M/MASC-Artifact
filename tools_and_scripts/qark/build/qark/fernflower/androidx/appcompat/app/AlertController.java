...
class AlertController {
   ...
   public AlertController(Context var1, AppCompatDialog var2, Window var3) {
      ...
      TypedArray var4 = var1.obtainStyledAttributes((AttributeSet)null, styleable.AlertDialog, attr.alertDialogStyle, 0);
      this.mAlertDialogLayout = var4.getResourceId(styleable.AlertDialog_android_layout, 0);
      this.mButtonPanelSideLayout = var4.getResourceId(styleable.AlertDialog_buttonPanelSideLayout, 0);
      this.mListLayout = var4.getResourceId(styleable.AlertDialog_listLayout, 0);
      this.mMultiChoiceItemLayout = var4.getResourceId(styleable.AlertDialog_multiChoiceItemLayout, 0);
      this.mSingleChoiceItemLayout = var4.getResourceId(styleable.AlertDialog_singleChoiceItemLayout, 0);
      this.mListItemLayout = var4.getResourceId(styleable.AlertDialog_listItemLayout, 0);
      this.mShowTitle = var4.getBoolean(styleable.AlertDialog_showTitle, true);
      this.mButtonIconDimen = var4.getDimensionPixelSize(styleable.AlertDialog_buttonIconDimen, 0);
      var4.recycle();
   ...
   private void setScrollIndicators(ViewGroup var1, final View var2, int var3, int var4) {
      final View var5 = this.mWindow.findViewById(id.scrollIndicatorUp);
      View var6 = this.mWindow.findViewById(id.scrollIndicatorDown);
   ...
   private void setupContent(ViewGroup var1) {
      NestedScrollView var3 = (NestedScrollView)this.mWindow.findViewById(id.scrollView);
      this.mScrollView = var3;
      var3.setFocusable(false);
      this.mScrollView.setNestedScrollingEnabled(false);
      TextView var5 = (TextView)var1.findViewById(16908299);
      this.mMessageView = var5;
      if (var5 != null) {
   ...
   private void setupCustomContent(ViewGroup var1) {
      ...
      if (var2) {
         FrameLayout var4 = (FrameLayout)this.mWindow.findViewById(id.custom);
   ...
   private void setupTitle(ViewGroup var1) {
      if (this.mCustomTitleView != null) {
         ...
         if (TextUtils.isEmpty(this.mTitle) ^ true && this.mShowTitle) {
            TextView var4 = (TextView)this.mWindow.findViewById(id.alertTitle);
   ...
   private void setupView() {
      View var8 = this.mWindow.findViewById(id.parentPanel);
      View var7 = var8.findViewById(id.topPanel);
      View var6 = var8.findViewById(id.contentPanel);
      View var5 = var8.findViewById(id.buttonPanel);
      ViewGroup var21 = (ViewGroup)var8.findViewById(id.customPanel);
      this.setupCustomContent(var21);
      View var11 = var21.findViewById(id.topPanel);
      View var10 = var21.findViewById(id.contentPanel);
      View var9 = var21.findViewById(id.buttonPanel);
      ...
      if (!var4 && var16 != null) {
         var5 = var16.findViewById(id.textSpacerNoButtons);
         if (var5 != null) {
      ...
      if (var3) {
         ...
         if (this.mMessage != null || this.mListView != null) {
            var5 = var18.findViewById(id.titleDividerNoCustom);
         }
         ...
         var5 = var16.findViewById(id.textSpacerNoTitle);
         if (var5 != null) {
            var5.setVisibility(0);
         }
      }
   ...
   private static boolean shouldCenterSingleButton(Context var0) {
      ...
      var0.getTheme().resolveAttribute(attr.alertDialogCenterButtons, var1, true);
      return var1.data != 0;
   }
   ...
   public static class RecycleListView extends ListView {
      ...
      public RecycleListView(Context var1, AttributeSet var2) {
         super(var1, var2);
         TypedArray var3 = var1.obtainStyledAttributes(var2, styleable.RecycleListView);
         this.mPaddingBottomNoButtons = var3.getDimensionPixelOffset(styleable.RecycleListView_paddingBottomNoButtons, -1);
         this.mPaddingTopNoTitle = var3.getDimensionPixelOffset(styleable.RecycleListView_paddingTopNoTitle, -1);
      }

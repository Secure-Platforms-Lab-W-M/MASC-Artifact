...
public final class MenuItemImpl implements SupportMenuItem {
   ...
   String getShortcutLabel() {
      ...
      if (var1 == 0) {
         ...
         Resources var3 = this.mMenu.getContext().getResources();
         StringBuilder var4 = new StringBuilder();
         if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            var4.append(var3.getString(string.abc_prepend_shortcut_label));
         }
         ...
         appendModifier(var4, var2, 65536, var3.getString(string.abc_menu_meta_shortcut_label));
         appendModifier(var4, var2, 4096, var3.getString(string.abc_menu_ctrl_shortcut_label));
         appendModifier(var4, var2, 2, var3.getString(string.abc_menu_alt_shortcut_label));
         appendModifier(var4, var2, 1, var3.getString(string.abc_menu_shift_shortcut_label));
         appendModifier(var4, var2, 4, var3.getString(string.abc_menu_sym_shortcut_label));
         appendModifier(var4, var2, 8, var3.getString(string.abc_menu_function_shortcut_label));
         if (var1 != '\b') {
            if (var1 != '\n') {
               if (var1 != ' ') {
                  var4.append(var1);
               } else {
                  var4.append(var3.getString(string.abc_menu_space_shortcut_label));
               }
            } else {
               var4.append(var3.getString(string.abc_menu_enter_shortcut_label));
            }
         } else {
            var4.append(var3.getString(string.abc_menu_delete_shortcut_label));
         }

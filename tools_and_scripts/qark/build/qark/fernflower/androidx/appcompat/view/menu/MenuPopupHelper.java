...
public class MenuPopupHelper implements MenuHelper {
   ...
   public MenuPopupHelper(Context var1, MenuBuilder var2) {
      this(var1, var2, (View)null, false, attr.popupMenuStyle, 0);
   }

   public MenuPopupHelper(Context var1, MenuBuilder var2, View var3) {
      this(var1, var2, var3, false, attr.popupMenuStyle, 0);
   }
   ...
   private MenuPopup createPopup() {
      ...
      boolean var1;
      if (Math.min(var3.x, var3.y) >= this.mContext.getResources().getDimensionPixelSize(dimen.abc_cascading_menus_min_smallest_width)) {
         var1 = true;
      } else {
         var1 = false;
      }

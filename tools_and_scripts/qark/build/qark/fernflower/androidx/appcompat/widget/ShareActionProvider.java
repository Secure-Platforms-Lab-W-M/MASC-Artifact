...
public class ShareActionProvider extends ActionProvider {
   ...
   public View onCreateActionView() {
      ...
      this.mContext.getTheme().resolveAttribute(attr.actionModeShareDrawable, var2, true);
      ...
      var1.setDefaultActionButtonContentDescription(string.abc_shareactionprovider_share_with_application);
      var1.setExpandActivityOverflowButtonContentDescription(string.abc_shareactionprovider_share_with);
      return var1;
   }
   ...
   public void onPrepareSubMenu(SubMenu var1) {
      ...
      if (var4 < var3) {
         var1 = var1.addSubMenu(0, var4, var4, this.mContext.getString(string.abc_activity_chooser_view_see_all));

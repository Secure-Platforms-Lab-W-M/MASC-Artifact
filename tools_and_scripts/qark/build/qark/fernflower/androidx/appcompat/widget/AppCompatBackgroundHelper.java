...
class AppCompatBackgroundHelper {
   ...
   void loadFromAttributes(AttributeSet var1, int var2) {
      TintTypedArray var24 = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), var1, styleable.ViewBackgroundHelper, var2, 0);
      ...
      label211: {
         ...
         label215: {
            ...
            label209: {
               ColorStateList var3;
               try {
                  if (!var24.hasValue(styleable.ViewBackgroundHelper_android_background)) {
                     break label209;
                  }

                  this.mBackgroundResId = var24.getResourceId(styleable.ViewBackgroundHelper_android_background, -1);
            ...
            try {
               if (var24.hasValue(styleable.ViewBackgroundHelper_backgroundTint)) {
                  ViewCompat.setBackgroundTintList(this.mView, var24.getColorStateList(styleable.ViewBackgroundHelper_backgroundTint));
               }
            ...
            label198:
            try {
               if (var24.hasValue(styleable.ViewBackgroundHelper_backgroundTintMode)) {
                  ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(var24.getInt(styleable.ViewBackgroundHelper_backgroundTintMode, -1), (Mode)null));
               }
               break label211;

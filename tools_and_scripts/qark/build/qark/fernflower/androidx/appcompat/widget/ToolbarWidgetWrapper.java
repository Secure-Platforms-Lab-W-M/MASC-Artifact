...
public class ToolbarWidgetWrapper implements DecorToolbar {
   ...
   public ToolbarWidgetWrapper(Toolbar var1, boolean var2) {
      this(var1, var2, string.abc_action_bar_up_description, drawable.abc_ic_ab_back_material);
   }
   ...
   public ToolbarWidgetWrapper(Toolbar var1, boolean var2, int var3, int var4) {
      ...
      TintTypedArray var8 = TintTypedArray.obtainStyledAttributes(var1.getContext(), (AttributeSet)null, styleable.ActionBar, attr.actionBarStyle, 0);
      this.mDefaultNavigationIcon = var8.getDrawable(styleable.ActionBar_homeAsUpIndicator);
      if (var2) {
         CharSequence var7 = var8.getText(styleable.ActionBar_title);
         if (!TextUtils.isEmpty(var7)) {
            this.setTitle(var7);
         }

         var7 = var8.getText(styleable.ActionBar_subtitle);
         if (!TextUtils.isEmpty(var7)) {
            this.setSubtitle(var7);
         }

         Drawable var9 = var8.getDrawable(styleable.ActionBar_logo);
         if (var9 != null) {
            this.setLogo(var9);
         }

         var9 = var8.getDrawable(styleable.ActionBar_icon);
         if (var9 != null) {
            this.setIcon(var9);
         }
         ...
         this.setDisplayOptions(var8.getInt(styleable.ActionBar_displayOptions, 0));
         var4 = var8.getResourceId(styleable.ActionBar_customNavigationLayout, 0);
         if (var4 != 0) {
         ...
         var4 = var8.getLayoutDimension(styleable.ActionBar_height, 0);
         if (var4 > 0) {
         ...
         var4 = var8.getDimensionPixelOffset(styleable.ActionBar_contentInsetStart, -1);
         int var5 = var8.getDimensionPixelOffset(styleable.ActionBar_contentInsetEnd, -1);
         if (var4 >= 0 || var5 >= 0) {
            this.mToolbar.setContentInsetsRelative(Math.max(var4, 0), Math.max(var5, 0));
         }

         var4 = var8.getResourceId(styleable.ActionBar_titleTextStyle, 0);
         Toolbar var11;
         if (var4 != 0) {
            var11 = this.mToolbar;
         ...
         var4 = var8.getResourceId(styleable.ActionBar_subtitleTextStyle, 0);
         if (var4 != 0) {
            var11 = this.mToolbar;
            var11.setSubtitleTextAppearance(var11.getContext(), var4);
         }

         var4 = var8.getResourceId(styleable.ActionBar_popupTheme, 0);
         if (var4 != 0) {
   ...
   public void setMenu(Menu var1, MenuPresenter.Callback var2) {
      if (this.mActionMenuPresenter == null) {
         ...
         var3.setId(id.action_menu_presenter);
      }

...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
   ...
   private Spinner createSpinner() {
      AppCompatSpinner var1 = new AppCompatSpinner(this.getContext(), (AttributeSet)null, attr.actionDropDownStyle);
   ...
   private LinearLayoutCompat createTabLayout() {
      LinearLayoutCompat var1 = new LinearLayoutCompat(this.getContext(), (AttributeSet)null, attr.actionBarTabBarStyle);
   ...
   private class TabView extends LinearLayout {
      ...
      public TabView(Context var2, ActionBar.Tab var3, boolean var4) {
         super(var2, (AttributeSet)null, attr.actionBarTabStyle);
         int[] var5 = new int[]{16842964};
         this.BG_ATTRS = var5;
         this.mTab = var3;
         TintTypedArray var6 = TintTypedArray.obtainStyledAttributes(var2, (AttributeSet)null, var5, attr.actionBarTabStyle, 0);
         if (var6.hasValue(0)) {
         ...
         if (var4 != null) {
            ...
            if (var1) {
               if (this.mTextView == null) {
                  AppCompatTextView var15 = new AppCompatTextView(this.getContext(), (AttributeSet)null, attr.actionBarTabTextStyle);
                  var15.setEllipsize(TruncateAt.END);
                  android.widget.LinearLayout.LayoutParams var16 = new android.widget.LinearLayout.LayoutParams(-2, -2);
                  var16.gravity = 16;

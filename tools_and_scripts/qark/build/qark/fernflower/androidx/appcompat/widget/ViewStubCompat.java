...
public final class ViewStubCompat extends View {
   ...
   public ViewStubCompat(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var4 = var1.obtainStyledAttributes(var2, styleable.ViewStubCompat, var3, 0);
      this.mInflatedId = var4.getResourceId(styleable.ViewStubCompat_android_inflatedId, -1);
      this.mLayoutResource = var4.getResourceId(styleable.ViewStubCompat_android_layout, 0);
      this.setId(var4.getResourceId(styleable.ViewStubCompat_android_id, -1));
      var4.recycle();

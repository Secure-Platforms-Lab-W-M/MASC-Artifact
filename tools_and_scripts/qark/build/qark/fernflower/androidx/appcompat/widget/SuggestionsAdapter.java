...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
   ...
   private CharSequence formatUrl(CharSequence var1) {
      if (this.mUrlColor == null) {
         ...
         this.mContext.getTheme().resolveAttribute(attr.textColorSearchUrl, var2, true);
   ...
   public View newView(Context var1, Cursor var2, ViewGroup var3) {
      ...
      ((ImageView)var4.findViewById(id.edit_query)).setImageResource(this.mCommitIconResId);
      return var4;
   }
   ...
   private static final class ChildViewCache {
      ...
      public ChildViewCache(View var1) {
         ...
         this.mIconRefine = (ImageView)var1.findViewById(id.edit_query);
      }
   }
}

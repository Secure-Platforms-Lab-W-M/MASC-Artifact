...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
   ...
   public ActionMenuPresenter(Context var1) {
      super(var1, layout.abc_action_menu_layout, layout.abc_action_menu_item_layout);
   }
   ...
   public boolean flagActionItems() {
      ...
      int var10 = var2 - var4;
      SparseBooleanArray var24 = var16.mActionButtonGroups;
      var24.clear();
      var6 = 0;
      var2 = 0;
      ...
      for(var9 = var3; var7 < var9; ++var7) {
         ...
         if (var19.requiresActionButton()) {
            ...
            boolean var14 = var24.get(var12);
            boolean var13;
            if (var4 <= 0 && !var14 || var22 <= 0 || this.mStrictWidthLimit && var2 <= 0) {
               var13 = false;
            } else {
               var13 = true;
            }
            ...
            if (var13) {
               var20 = this.getItemView(var19, (View)null, var17);
               if (this.mStrictWidthLimit) {
                  var3 = ActionMenuView.measureChildForCells(var20, var6, var2, var11, 0);
                  var2 -= var3;
                  if (var3 == 0) {
                     var13 = false;
                  }
            ...
            var1 = var4;
            if (var13 && var12 != 0) {
               var24.put(var12, true);
            } else if (var14) {
               var24.put(var12, false);

               for(var10 = 0; var10 < var7; var1 = var4) {
                  MenuItemImpl var23 = (MenuItemImpl)var15.get(var10);
                  var4 = var1;
                  if (var23.getGroupId() == var12) {
                     var4 = var1;
   ...
   public boolean onSubMenuSelected(SubMenuBuilder var1) {
      if (!var1.hasVisibleItems()) {
         ...
         if (var8 == null) {
            ...
            ActionMenuPresenter.ActionButtonSubmenu var9 = new ActionMenuPresenter.ActionButtonSubmenu(this.mContext, var1, var8);
   ...
   private class ActionButtonSubmenu extends MenuPopupHelper {
      public ActionButtonSubmenu(Context var2, SubMenuBuilder var3, View var4) {
         super(var2, var3, var4, false, attr.actionOverflowMenuStyle);
   ...
   private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
      ...
      public OverflowMenuButton(Context var2) {
         super(var2, (AttributeSet)null, attr.actionOverflowButtonStyle);
   ...
   private class OverflowPopup extends MenuPopupHelper {
      public OverflowPopup(Context var2, MenuBuilder var3, View var4, boolean var5) {
         super(var2, var3, var4, var5, attr.actionOverflowMenuStyle);

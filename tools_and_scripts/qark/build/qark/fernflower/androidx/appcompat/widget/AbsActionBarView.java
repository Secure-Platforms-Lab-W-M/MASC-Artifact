...
abstract class AbsActionBarView extends ViewGroup {
   ...
   AbsActionBarView(Context var1, AttributeSet var2, int var3) {
      ...
      if (var1.getTheme().resolveAttribute(attr.actionBarPopupTheme, var4, true) && var4.resourceId != 0) {
   ...
   protected void onConfigurationChanged(Configuration var1) {
      ...
      TypedArray var2 = this.getContext().obtainStyledAttributes((AttributeSet)null, styleable.ActionBar, attr.actionBarStyle, 0);
      this.setContentHeight(var2.getLayoutDimension(styleable.ActionBar_height, 0));
      var2.recycle();

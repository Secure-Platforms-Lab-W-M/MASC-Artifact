...
class PathInterpolatorApi14 implements Interpolator {
   ...
   private final float[] field_74;
   // $FF: renamed from: mY float[]
   private final float[] field_75;
   ...
   PathInterpolatorApi14(Path var1) {
      ...
      this.field_74 = new float[var4];
      this.field_75 = new float[var4];
      float[] var5 = new float[2];

      for(int var3 = 0; var3 < var4; ++var3) {
         var6.getPosTan((float)var3 * var2 / (float)(var4 - 1), var5, (float[])null);
         this.field_74[var3] = var5[0];
         this.field_75[var3] = var5[1];
      }
   ...
   public float getInterpolation(float var1) {
      if (var1 <= 0.0F) {
         ...
         int var3 = 0;
         int var4 = this.field_74.length - 1;

         while(var4 - var3 > 1) {
            int var5 = (var3 + var4) / 2;
            if (var1 < this.field_74[var5]) {
               var4 = var5;
            } else {
               var3 = var5;
            }
         ...
         float[] var6 = this.field_74;
         float var2 = var6[var4] - var6[var3];
         if (var2 == 0.0F) {
            return this.field_75[var3];
         } else {

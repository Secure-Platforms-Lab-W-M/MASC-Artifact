...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
   ...
   private int fill(RecyclerView.Recycler var1, LayoutState var2, RecyclerView.State var3) {
      ...
      for(var5 = false; var2.hasMore(var3) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty()); var5 = true) {
         ...
         if (var2.mLayoutDirection == 1) {
            ...
            var10 = this.mPrimaryOrientation.getDecoratedMeasurement(var13) + var16;
            var7 = var16;
            var8 = var10;
            if (var9) {
               var7 = var16;
         ...
         if (this.isLayoutRTL() && this.mOrientation == 1) {
            ...
            var10 = this.mSecondaryOrientation.getDecoratedMeasurement(var13);
            var17 = var16;
            var16 -= var10;
         } else {
            if (var14.mFullSpan) {
            ...
            var17 = this.mSecondaryOrientation.getDecoratedMeasurement(var13) + var16;
         }
         ...
         if (this.mLayoutState.mStopInFocusable && var13.hasFocusable()) {
            if (var14.mFullSpan) {
   ...
   private StaggeredGridLayoutManager.Span getNextSpan(LayoutState var1) {
      ...
      if (var1.mLayoutDirection == 1) {
         ...
         for(var8 = this.mPrimaryOrientation.getStartAfterPadding(); var2 != var3; var5 = var6) {
         ...
         for(var8 = this.mPrimaryOrientation.getEndAfterPadding(); var2 != var3; var5 = var6) {
            var9 = this.mSpans[var2];
   ...
   private void recycleFromEnd(RecyclerView.Recycler var1, int var2) {
      for(int var3 = this.getChildCount() - 1; var3 >= 0; --var3) {
         ...
         if (this.mPrimaryOrientation.getDecoratedStart(var5) < var2 || this.mPrimaryOrientation.getTransformedStartWithDecoration(var5) < var2) {
            return;
         }
   ...
   private void updateLayoutState(int var1, RecyclerView.State var2) {
      ...
      if (this.getClipToPadding()) {
         ...
         this.mLayoutState.mEndLine = this.mPrimaryOrientation.getEndAfterPadding() + var4;
      } else {
         this.mLayoutState.mEndLine = this.mPrimaryOrientation.getEnd() + var4;
   ...
   public void collectAdjacentPrefetchPositions(int var1, int var2, RecyclerView.State var3, RecyclerView.LayoutManager.LayoutPrefetchRegistry var4) {
      ...
      if (this.getChildCount() != 0) {
         if (var1 != 0) {
            ...
            int[] var7 = this.mPrefetchDistances;
            if (var7 == null || var7.length < this.mSpanCount) {
            ...
            int var5;
            for(var2 = 0; var2 < this.mSpanCount; var1 = var5) {
               int var6;
   ...
   View findFirstVisibleItemClosestToEnd(boolean var1) {
      ...
      View var8;
      for(int var2 = this.getChildCount() - 1; var2 >= 0; var7 = var8) {
         View var9 = this.getChildAt(var2);
         int var5 = this.mPrimaryOrientation.getDecoratedStart(var9);
         int var6 = this.mPrimaryOrientation.getDecoratedEnd(var9);
         var8 = var7;
         if (var6 > var3) {
            if (var5 >= var4) {
               var8 = var7;
   ...
   View findFirstVisibleItemClosestToStart(boolean var1) {
      ...
      View var8;
      for(int var2 = 0; var2 < var5; var7 = var8) {
         View var9 = this.getChildAt(var2);
   ...
   View hasGapsToFix() {
      ...
      BitSet var9 = new BitSet(this.mSpanCount);
      var9.set(0, this.mSpanCount, true);
      ...
      for(int var15 = var1; var15 != var3; var15 += var4) {
         View var10 = this.getChildAt(var15);
         StaggeredGridLayoutManager.LayoutParams var11 = (StaggeredGridLayoutManager.LayoutParams)var10.getLayoutParams();
         if (var9.get(var11.mSpan.mIndex)) {
            if (this.checkSpanForGap(var11.mSpan)) {
               return var10;
            }

            var9.clear(var11.mSpan.mIndex);
         }

         if (!var11.mFullSpan && var15 + var4 != var3) {
            View var12 = this.getChildAt(var15 + var4);
            boolean var6 = false;
            boolean var13 = false;
            int var7;
            if (this.mShouldReverseLayout) {
               int var16 = this.mPrimaryOrientation.getDecoratedEnd(var10);
               var7 = this.mPrimaryOrientation.getDecoratedEnd(var12);
               if (var16 < var7) {
                  return var10;
               }
               ...
               var7 = this.mPrimaryOrientation.getDecoratedStart(var10);
               int var8 = this.mPrimaryOrientation.getDecoratedStart(var12);
               if (var7 > var8) {
                  return var10;
               }
            ...
            if (var13) {
               StaggeredGridLayoutManager.LayoutParams var17 = (StaggeredGridLayoutManager.LayoutParams)var12.getLayoutParams();
               if (var11.mSpan.mIndex - var17.mSpan.mIndex < 0) {
                  var13 = true;
               } else {
                  var13 = false;
               }
   ...
   public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler var1, RecyclerView.State var2, View var3, AccessibilityNodeInfoCompat var4) {
      ...
      if (!(var7 instanceof StaggeredGridLayoutManager.LayoutParams)) {
         ...
         if (this.mOrientation == 0) {
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(var6, var5, -1, -1, false, false));
         } else {
            var6 = var8.getSpanIndex();
            if (var8.mFullSpan) {
               var5 = this.mSpanCount;
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, var6, var5, false, false));
         }
      }
   }
   ...
   public Parcelable onSaveInstanceState() {
      if (this.mPendingSavedState != null) {
         ...
         StaggeredGridLayoutManager.SavedState var4 = new StaggeredGridLayoutManager.SavedState();
         ...
         StaggeredGridLayoutManager.LazySpanLookup var5 = this.mLazySpanLookup;
         ...
         if (this.getChildCount() > 0) {
            ...
            var4.mSpanOffsets = new int[this.mSpanCount];

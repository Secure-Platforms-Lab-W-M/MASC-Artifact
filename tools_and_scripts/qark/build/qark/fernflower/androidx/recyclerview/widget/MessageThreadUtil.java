      ...
      return new ThreadUtil.BackgroundCallback() {
...

         {
            ...
            this.mBackgroundRunnable = new Runnable() {
               public void run() {
                  while(true) {
                     MessageThreadUtil.SyncQueueItem var2 = mQueue.next();
                     if (var2 == null) {
                        ...
                        if (var1x != 2) {
                           if (var1x != 3) {
                              if (var1x != 4) {
                                 ...
                                 var3.append(var2.what);
                                 Log.e("ThreadUtil", var3.toString());
                              } else {
                                 TileList.Tile var4 = (TileList.Tile)var2.data;
                                 var1.recycleTile(var4);
                              }
                           } else {
                              var1.loadTile(var2.arg1, var2.arg2);
                           }
                        } else {
                           mQueue.removeMessages(2);
                           mQueue.removeMessages(3);
                           var1.updateRange(var2.arg1, var2.arg2, var2.arg3, var2.arg4, var2.arg5);
                        }
                     } else {
                        mQueue.removeMessages(1);
                        var1.refresh(var2.arg1);
                     }
                  }
               }
            };
   ...
   public ThreadUtil.MainThreadCallback getMainThreadProxy(final ThreadUtil.MainThreadCallback var1) {
      return new ThreadUtil.MainThreadCallback() {
         ...
         private Runnable mMainThreadRunnable = new Runnable() {
            public void run() {
               for(MessageThreadUtil.SyncQueueItem var2 = mQueue.next(); var2 != null; var2 = mQueue.next()) {
                  int var1x = var2.what;
                  if (var1x != 1) {
                     if (var1x != 2) {
                        if (var1x != 3) {
                           ...
                           var1.removeTile(var2.arg1, var2.arg2);
                        }
                     } else {
                        TileList.Tile var4 = (TileList.Tile)var2.data;
                        var1.addTile(var2.arg1, var4);
                     }
                  } else {
                     var1.updateItemCount(var2.arg1, var2.arg2);
                  }
               }

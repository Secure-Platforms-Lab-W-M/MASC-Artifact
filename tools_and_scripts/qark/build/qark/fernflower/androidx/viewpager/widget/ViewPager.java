      ...
      for(int var6 = 0; var6 < var12; var2 = var4) {
         ...
         if (var13.getVisibility() == 8) {
            ...
            if (var14 != null && var14.isDecor) {
               ...
               var13.measure(MeasureSpec.makeMeasureSpec(var3, var11), MeasureSpec.makeMeasureSpec(var5, var4));
               if (var15) {
      ...
      if (this.mAdapter == null) {
         ...
         if (var11 != this.mExpectedAdapterCount) {
            ...
            if (var16 != null) {
               ...
               this.mAdapter.setPrimaryItem((ViewGroup)this, this.mCurItem, var16.object);
            }
            ...
            for(var1 = 0; var1 < var5; ++var1) {
               ...
               if (!var21.isDecor && var21.widthFactor == 0.0F) {
                  var15 = this.infoForChild(var19);
                  if (var15 != null) {
                     var21.widthFactor = var15.widthFactor;
                     var21.position = var15.position;
                  }
               }
            }
            ...
            if (this.hasFocus()) {
               ...
               if (var22 != null) {
                  var14 = this.infoForAnyChild(var22);
               } else {
                  var14 = null;
               }
               ...
               if (var14 == null || var14.position != this.mCurItem) {
                  for(var1 = 0; var1 < this.getChildCount(); ++var1) {
                     ...
                     var15 = this.infoForChild(var22);
                     if (var15 != null && var15.position == this.mCurItem && var22.requestFocus(2)) {
                        return;
                     }
                  }
               }

...
public class AnimatorInflaterCompat {
      ...
      while(true) {
         ...
         if (var8 == 2) {
            ...
            if (var13.equals("objectAnimator")) {
               ...
               if (var19 != null && var11 instanceof ValueAnimator) {
   ...
   private static void setupPathMotion(Path var0, ObjectAnimator var1, float var2, String var3, String var4) {
      ...
      int var8;
      for(int var6 = 0; var6 < var9; var7 = var8) {
         var14.getPosTan(var2 - (Float)var10.get(var7), var13, (float[])null);
         var12[var6] = var13[0];
         var17[var6] = var13[1];
         var2 += var5;
         var8 = var7;
         if (var7 + 1 < var10.size()) {
            var8 = var7;
            if (var2 > (Float)var10.get(var7 + 1)) {
               var8 = var7 + 1;
               var14.nextContour();
            }
         }

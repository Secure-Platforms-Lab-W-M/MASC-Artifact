...
public abstract class ConfigurationAccess {
   ...
   public static ConfigurationAccess getRemote(LoggerInterface var0, String var1, int var2, String var3) throws IOException {
      return new RemoteAccessClient(var0, var1, var2, var3);
   }
   ...
   public static class ConfigurationAccessException extends IOException {
      public ConfigurationAccessException(String var1) {
         super(var1);
      }

      public ConfigurationAccessException(String var1, IOException var2) {
         super(var1, var2);
      }
   }
}

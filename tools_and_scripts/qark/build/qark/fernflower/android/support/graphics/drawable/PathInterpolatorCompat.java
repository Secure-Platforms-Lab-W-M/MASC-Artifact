...
public class PathInterpolatorCompat implements Interpolator {
   ...
   private void initPath(Path var1) {
      ...
      if (var6 <= 0) {
         ...
         var9.append(var2);
         IllegalArgumentException var10 = new IllegalArgumentException(var9.toString());
         throw var10;
      } else {
         this.field_3 = new float[var6];
         this.field_4 = new float[var6];
         float[] var7 = new float[2];

         int var4;
         for(var4 = 0; var4 < var6; ++var4) {
            var8.getPosTan((float)var4 * var2 / (float)(var6 - 1), var7, (float[])null);
            this.field_3[var4] = var7[0];
            this.field_4[var4] = var7[1];
         }

         if ((double)Math.abs(this.field_3[0]) <= 1.0E-5D && (double)Math.abs(this.field_4[0]) <= 1.0E-5D && (double)Math.abs(this.field_3[var6 - 1] - 1.0F) <= 1.0E-5D && (double)Math.abs(this.field_4[var6 - 1] - 1.0F) <= 1.0E-5D) {
            var2 = 0.0F;
            var4 = 0;
            ...
            var9.append(this.field_3[0]);
            var9.append(",");
            var9.append(this.field_4[0]);
            var9.append(" end:");
            var9.append(this.field_3[var6 - 1]);
            var9.append(",");
            var9.append(this.field_4[var6 - 1]);
            throw new IllegalArgumentException(var9.toString());
         }
      }
   }
   ...
   public float getInterpolation(float var1) {
      if (var1 <= 0.0F) {
         ...
         int var3 = 0;
         int var4 = this.field_3.length - 1;

         while(var4 - var3 > 1) {
            int var5 = (var3 + var4) / 2;
            if (var1 < this.field_3[var5]) {
               var4 = var5;
            } else {
               var3 = var5;
            }
         ...
         float[] var6 = this.field_3;
         float var2 = var6[var4] - var6[var3];
         if (var2 == 0.0F) {
            return this.field_4[var3];
         } else {

...
public class ViewDragHelper {
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      if (var8 != 0) {
               ...
               if (this.mInitialMotionX != null && this.mInitialMotionY != null) {
                  ...
                  for(int var9 = 0; var9 < var6; ++var9) {
                     ...
                     if (this.isValidPointerForActionMove(var11)) {
                        ...
                        View var18 = this.findTopChildUnder((int)var2, (int)var3);
                        boolean var10;
                        if (var18 != null && this.checkTouchSlop(var18, var4, var5)) {
                           var10 = true;
                        } else {
                           var10 = false;
                        }
                        ...
                        if (var10) {
                           int var12 = var18.getLeft();
                           int var13 = (int)var4;
                           var13 = this.mCallback.clampViewPositionHorizontal(var18, var13 + var12, (int)var4);
                           int var14 = var18.getTop();
                           int var15 = (int)var5;
                           var15 = this.mCallback.clampViewPositionVertical(var18, var15 + var14, (int)var5);
                           int var16 = this.mCallback.getViewHorizontalDragRange(var18);
                           int var17 = this.mCallback.getViewVerticalDragRange(var18);
                        ...
                        if (this.mDragState == 1 || var10 && this.tryCaptureViewForDrag(var18, var11)) {
                           break;
                        }
                     }
                  }
            ...
            if (var8 != 3) {
               if (var8 != 5) {
                  ...
                  if (var7 == 0) {
                     ...
                     var19 = this.findTopChildUnder((int)var2, (int)var3);
                     if (var19 == this.mCapturedView) {
                        this.tryCaptureViewForDrag(var19, var6);
                     }
         ...
         this.saveInitialMotion(var2, var3, var6);
         var19 = this.findTopChildUnder((int)var2, (int)var3);
         if (var19 == this.mCapturedView && this.mDragState == 2) {
            this.tryCaptureViewForDrag(var19, var6);
         }

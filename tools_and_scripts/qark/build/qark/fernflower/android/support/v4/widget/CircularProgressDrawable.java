...
public class CircularProgressDrawable extends Drawable implements Animatable {
   ...
   private void applyTransformation(float var1, CircularProgressDrawable.Ring var2, boolean var3) {
      if (this.mFinishing) {
         ...
         if (var1 != 1.0F || var3) {
            ...
            if (var1 < 0.5F) {
               var4 = var1 / 0.5F;
               var5 = var2.getStartingStartTrim();
               var7 = MATERIAL_INTERPOLATOR.getInterpolation(var4);
               var4 = var5;
               var5 += var7 * 0.79F + 0.01F;
            } else {
               var4 = (var1 - 0.5F) / 0.5F;
            ...
            var7 = this.mRotationCount;
            var2.setStartTrim(var4);
            var2.setEndTrim(var5);
            var2.setRotation(0.20999998F * var1 + var6);
            this.setRotation((var7 + var1) * 216.0F);
         }
      ...
      var2.addListener(new AnimatorListener() {
         ...
         public void onAnimationRepeat(Animator var1x) {
            ...
            if (CircularProgressDrawable.this.mFinishing) {
               ...
               var2.mRotationCount = var2.mRotationCount + 1.0F;
            }
         }
   ...
   private void updateRingColor(float var1, CircularProgressDrawable.Ring var2) {
      if (var1 > 0.75F) {
   ...
   private static class Ring {
      ...
      void setColors(@NonNull int[] var1) {
         this.mColors = var1;

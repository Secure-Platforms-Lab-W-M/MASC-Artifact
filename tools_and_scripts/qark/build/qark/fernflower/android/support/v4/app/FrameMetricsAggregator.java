...
public class FrameMetricsAggregator {
   ...
   public void add(@NonNull Activity var1) {
   ...
   @Nullable
   public SparseIntArray[] remove(@NonNull Activity var1) {
   ...
   private static class FrameMetricsApi24Impl extends FrameMetricsAggregator.FrameMetricsBaseImpl {
      ...
      public void add(Activity var1) {
         ...
         for(int var2 = 0; var2 <= 8; ++var2) {
            SparseIntArray[] var3 = this.mMetrics;
            if (var3[var2] == null && (this.mTrackingFlags & 1 << var2) != 0) {
               var3[var2] = new SparseIntArray();
            }
         }
   ...
   private static class FrameMetricsBaseImpl {
      ...
      // $FF: synthetic method
      FrameMetricsBaseImpl(Object var1) {
         this();
      }

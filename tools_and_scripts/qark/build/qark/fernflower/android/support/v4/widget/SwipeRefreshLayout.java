...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
   ...
   public SwipeRefreshLayout(Context var1, AttributeSet var2) {
      ...
      this.mSpinnerOffsetEnd = (int)(var4.density * 64.0F);
   ...
   private void moveSpinner(float var1) {
      ...
      double var2 = (double)var6;
      Double.isNaN(var2);
      float var7 = (float)Math.max(var2 - 0.4D, 0.0D) * 5.0F / 3.0F;
      float var9 = Math.abs(var1);
      float var10 = this.mTotalDragDistance;
      int var11;
      if (this.mUsingCustomStart) {
         var11 = this.mSpinnerOffsetEnd - this.mOriginalOffsetTop;
      } else {
         var11 = this.mSpinnerOffsetEnd;
      }

      float var8 = (float)var11;
      var9 = Math.max(0.0F, Math.min(var9 - var10, var8 * 2.0F) / var8);
      var2 = (double)(var9 / 4.0F);
      double var4 = Math.pow((double)(var9 / 4.0F), 2.0D);
      Double.isNaN(var2);
      var9 = (float)(var2 - var4) * 2.0F;
      var11 = this.mOriginalOffsetTop;
      int var12 = (int)(var8 * var6 + var8 * var9 * 2.0F);
      ...
      this.mProgress.setStartEndTrim(0.0F, Math.min(0.8F, var7 * 0.8F));
      this.mProgress.setArrowScale(Math.min(1.0F, var7));
      this.mProgress.setProgressRotation((0.4F * var7 - 0.25F + 2.0F * var9) * 0.5F);
      this.setTargetOffsetTopAndBottom(var11 + var12 - this.mCurrentTargetOffsetTop);
   }

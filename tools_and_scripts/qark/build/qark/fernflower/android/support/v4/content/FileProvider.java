      ...
      if (var5 != null) {
         while(true) {
            ...
            if (var2 == 2) {
               ...
               } else if ("external-files-path".equals(var8)) {
                  var3 = ContextCompat.getExternalFilesDirs(var0, (String)null);
                  if (var3.length > 0) {
                     var10 = var3[0];
                  }
               } else if ("external-cache-path".equals(var8)) {
                  File[] var11 = ContextCompat.getExternalCacheDirs(var0);
                  var10 = var3;
                  if (var11.length > 0) {
                     var10 = var11[0];
                  }
               ...
               if (var10 != null) {
                  var4.addRoot(var6, buildPath(var10, var7));
               }
            }
         }
      } else {
         IllegalArgumentException var9 = new IllegalArgumentException("Missing android.support.FILE_PROVIDER_PATHS meta-data");
         throw var9;
      }
   }
   ...
   static class SimplePathStrategy implements FileProvider.PathStrategy {
      ...
      public Uri getUriForFile(File var1) {
         ...
         try {
            ...
            var2.append(var1);
            IllegalArgumentException var8 = new IllegalArgumentException(var2.toString());
            throw var8;
         }
         ...
         Entry var10;
         for(Iterator var5 = this.mRoots.entrySet().iterator(); var5.hasNext(); var9 = var10) {
            ...
            if (var4.startsWith(var6)) {
               if (var9 != null) {
                  var10 = var9;
                  if (var6.length() <= ((File)var9.getValue()).getPath().length()) {
                     continue;
                  }
               }
         ...
         if (var9 != null) {
            String var14 = ((File)var9.getValue()).getPath();
            if (var14.endsWith("/")) {
               var14 = var4.substring(var14.length());
            } else {
               var14 = var4.substring(var14.length() + 1);
            }

            StringBuilder var13 = new StringBuilder();
            var13.append(Uri.encode((String)var9.getKey()));
            var13.append('/');
            var13.append(Uri.encode(var14, "/"));
            String var12 = var13.toString();
            return (new Builder()).scheme("content").authority(this.mAuthority).encodedPath(var12).build();
         } else {
            StringBuilder var11 = new StringBuilder();
            var11.append("Failed to find configured root that contains ");
            var11.append(var4);

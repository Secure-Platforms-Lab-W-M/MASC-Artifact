   ...
   public long getStartDelay(ViewGroup var1, Transition var2, TransitionValues var3, TransitionValues var4) {
      if (var3 == null && var4 == null) {
         ...
         if (var13 != null) {
            ...
            int[] var14 = new int[2];
            var1.getLocationOnScreen(var14);
            var7 = Math.round((float)(var14[0] + var1.getWidth() / 2) + var1.getTranslationX());
            var8 = Math.round((float)(var14[1] + var1.getHeight() / 2) + var1.getTranslationY());
         }

...
public class ChangeTransform extends Transition {
   ...
   private ObjectAnimator createTransformAnimator(TransitionValues var1, TransitionValues var2, final boolean var3) {
      Matrix var4 = (Matrix)var1.values.get("android:changeTransform:matrix");
      final Matrix var9 = (Matrix)var2.values.get("android:changeTransform:matrix");
      if (var4 == null) {
      ...
      if (var4.equals(var9)) {
         ...
         final ChangeTransform.Transforms var5 = (ChangeTransform.Transforms)var2.values.get("android:changeTransform:transforms");
         ...
         Path var13 = this.getPathMotion().getPath(var6[2], var6[5], var8[2], var8[5]);
         ObjectAnimator var14 = ObjectAnimator.ofPropertyValuesHolder(var12, new PropertyValuesHolder[]{var7, PropertyValuesHolderUtils.ofPointF(TRANSLATIONS_PROPERTY, var13)});
         ...
         AnimatorUtils.addPauseListener(var14, var11);
         return var14;
      }
   }
   ...
   private static void setIdentityTransforms(View var0) {
   ...
   private void setMatricesForParent(TransitionValues var1, TransitionValues var2) {
      Matrix var4 = (Matrix)var2.values.get("android:changeTransform:parentMatrix");
      var2.view.setTag(R$id.parent_matrix, var4);
      Matrix var3 = this.mTempMatrix;
      var3.reset();
      var4.invert(var3);
      Matrix var5 = (Matrix)var1.values.get("android:changeTransform:matrix");
      if (var5 == null) {
         var5 = new Matrix();
         var1.values.put("android:changeTransform:matrix", var5);
      }
   ...
   private static void setTransforms(View var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {

...
class ViewBoundsCheck {
   ...
   static final int field_35 = 1;
   // $FF: renamed from: LT int
   static final int field_36 = 4;
   ...
   View findOneViewWithinBoundFlags(int var1, int var2, int var3, int var4) {
      ...
      View var10;
      for(var10 = null; var1 != var2; var1 += var5) {
         View var11 = this.mCallback.getChildAt(var1);
         int var8 = this.mCallback.getChildStart(var11);
         int var9 = this.mCallback.getChildEnd(var11);
   ...
   static class BoundFlags {
      ...
      void setFlags(int var1, int var2) {
         this.mBoundFlags = this.mBoundFlags & ~var2 | var1 & var2;
      }
   }

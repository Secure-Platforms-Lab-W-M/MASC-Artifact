...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
   ...
   final ViewPropertyAnimatorListener mHideListener = new ViewPropertyAnimatorListenerAdapter() {
      public void onAnimationEnd(View var1) {
         ...
         WindowDecorActionBar var2 = WindowDecorActionBar.this;
         var2.mCurrentShowAnim = null;
         var2.completeDeferredDestroyActionMode();
   ...
   final ViewPropertyAnimatorListener mShowListener = new ViewPropertyAnimatorListenerAdapter() {
      public void onAnimationEnd(View var1) {
         WindowDecorActionBar var2 = WindowDecorActionBar.this;
         var2.mCurrentShowAnim = null;
         var2.mContainerView.requestLayout();
      }
   };
   ...
   private void configureTab(ActionBar.Tab var1, int var2) {
      ...
      if (var4.getCallback() == null) {
         IllegalStateException var5 = new IllegalStateException("Action Bar Tab must have a Callback");
         throw var5;
      } else {
   ...
   private void init(View var1) {
      ...
      ActionBarOverlayLayout var4 = this.mOverlayLayout;
      if (var4 != null) {
      ...
      if (var5 != null && this.mContextView != null && this.mContainerView != null) {
         ...
         TypedArray var8 = this.mContext.obtainStyledAttributes((AttributeSet)null, R$styleable.ActionBar, R$attr.actionBarStyle, 0);
         if (var8.getBoolean(R$styleable.ActionBar_hideOnContentScroll, false)) {
            this.setHideOnContentScrollEnabled(true);
         }

         int var9 = var8.getDimensionPixelSize(R$styleable.ActionBar_elevation, 0);
         if (var9 != 0) {
         ...
         var6.append(" can only be used ");
         var6.append("with a compatible window decor layout");
   ...
   public void selectTab(ActionBar.Tab var1) {
      ...
      if (var3 != 2) {
         ...
         if (var5 == var1) {
            ...
            WindowDecorActionBar.TabImpl var6 = this.mSelectedTab;
            if (var6 != null) {
      ...
      public void finish() {
         if (WindowDecorActionBar.this.mActionMode == this) {
            if (!WindowDecorActionBar.checkShowingFlags(WindowDecorActionBar.this.mHiddenByApp, WindowDecorActionBar.this.mHiddenBySystem, false)) {
               WindowDecorActionBar var1 = WindowDecorActionBar.this;
               var1.mDeferredDestroyActionMode = this;
               var1.mDeferredModeDestroyCallback = this.mCallback;
            } else {

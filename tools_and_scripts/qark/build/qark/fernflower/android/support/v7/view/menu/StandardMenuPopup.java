...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
      ...
      if (this.isShowing()) {
         ...
         if (var2 == null) {
            ...
            if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
               FrameLayout var3 = (FrameLayout)LayoutInflater.from(this.mContext).inflate(R$layout.abc_popup_menu_header_item_layout, var5, false);
               TextView var4 = (TextView)var3.findViewById(16908310);
               if (var4 != null) {
                  var4.setText(this.mMenu.getHeaderTitle());
               }

               var3.setEnabled(false);
               var5.addHeaderView(var3, (Object)null, false);
            }
   ...
   public boolean onSubMenuSelected(SubMenuBuilder var1) {
      if (var1.hasVisibleItems()) {
         ...
         var2.setGravity(this.mDropDownGravity);
         var2.setOnDismissListener(this.mOnDismissListener);
         this.mOnDismissListener = null;
         this.mMenu.close(false);
         if (var2.tryShow(this.mPopup.getHorizontalOffset(), this.mPopup.getVerticalOffset())) {
            MenuPresenter.Callback var3 = this.mPresenterCallback;
            if (var3 != null) {
               var3.onOpenSubMenu(var1);
            }

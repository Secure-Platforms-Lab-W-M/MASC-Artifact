...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
         ...
         if (var3 == 0) {
            ...
            if (ItemTouchHelper.this.mSelected == null) {
               ...
               if (var6 != null) {
                  ...
                  var5.mInitialTouchX -= var6.field_25;
                  var5 = ItemTouchHelper.this;
                  var5.mInitialTouchY -= var6.field_26;
      ...
      for(int var4 = 0; var4 < var13; ++var4) {
         ...
         if (var18 != var1.itemView && var18.getBottom() >= var8 && var18.getTop() <= var10 && var18.getRight() >= var3 && var18.getLeft() <= var9) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var17)) {
               ...
               var5 = this.mSwapTargets.size();
               var6 = 0;

               int var7;
               for(var7 = 0; var6 < var5 && var14 > (Integer)this.mDistances.get(var6); ++var6) {
                  ++var7;
               }
   ...
   private void initGestureDetector() {
      if (this.mGestureDetector == null) {
         this.mGestureDetector = new GestureDetectorCompat(this.mRecyclerView.getContext(), new ItemTouchHelper.ItemTouchHelperGestureListener());
      }
   }
      ...
      if (this.mActionState == 2) {
         ...
         if (var2 == 0) {
            ...
            if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
               ...
               if (var4 > 0) {
                  return (var3 & var4) == 0 ? ItemTouchHelper.Callback.convertToRelativeDirection(var4, ViewCompat.getLayoutDirection(this.mRecyclerView)) : var4;
               } else {
               ...
               if (var4 > 0) {
                  ...
                  if (var2 > 0) {
                     return (var3 & var2) == 0 ? ItemTouchHelper.Callback.convertToRelativeDirection(var2, ViewCompat.getLayoutDirection(this.mRecyclerView)) : var2;
                  } else {
                     return 0;
                  }
               }
   ...
   boolean checkSelectForSwipe(int var1, MotionEvent var2, int var3) {
   ...
   int endRecoverAnimation(RecyclerView.ViewHolder var1, boolean var2) {
   ...
   View findChildView(MotionEvent var1) {
      ...
      for(int var4 = this.mRecoverAnimations.size() - 1; var4 >= 0; --var4) {
         ...
         if (hitTest(var5, var2, var3, var8.field_25, var8.field_26)) {
            return var5;
         }
      }
   ...
   void postDispatchSwipe(final ItemTouchHelper.RecoverAnimation var1, final int var2) {
      this.mRecyclerView.post(new Runnable() {
         public void run() {
            if (ItemTouchHelper.this.mRecyclerView != null && ItemTouchHelper.this.mRecyclerView.isAttachedToWindow() && !var1.mOverridden) {
               if (var1.mViewHolder.getAdapterPosition() != -1) {
   ...
   boolean scrollIfNecessary() {
      if (this.mSelected == null) {
         ...
         if (var9.canScrollHorizontally()) {
            ...
            var3 = var4 - this.mTmpRect.left - this.mRecyclerView.getPaddingLeft();
            if (this.mDx < 0.0F && var3 < 0) {
               var1 = var3;
            } else if (this.mDx > 0.0F) {
               var3 = this.mSelected.itemView.getWidth() + var4 + this.mTmpRect.right - (this.mRecyclerView.getWidth() - this.mRecyclerView.getPaddingRight());
               if (var3 > 0) {
                  var1 = var3;
               }
            }
         ...
         if (var9.canScrollVertically()) {
            ...
            if (this.mDy < 0.0F && var3 < 0) {
               var2 = var3;
            } else if (this.mDy > 0.0F) {
               var3 = this.mSelected.itemView.getHeight() + var4 + this.mTmpRect.bottom - (this.mRecyclerView.getHeight() - this.mRecyclerView.getPaddingBottom());
               if (var3 > 0) {
                  var2 = var3;
               }
            }
         ...
         if (var1 != 0) {
            var1 = this.mCallback.interpolateOutOfBoundsScroll(this.mRecyclerView, this.mSelected.itemView.getWidth(), var1, this.mRecyclerView.getWidth(), var5);
         }

         if (var2 != 0) {
            var2 = this.mCallback.interpolateOutOfBoundsScroll(this.mRecyclerView, this.mSelected.itemView.getHeight(), var2, this.mRecyclerView.getHeight(), var5);
         }
         ...
         if (var1 == 0 && var2 == 0) {
            ...
            this.mRecyclerView.scrollBy(var1, var2);
            return true;
         }
      }
   }
         ...
         if (this.mSelected != null) {
            ...
            if (var11.itemView.getParent() != null) {
               ...
               if (var15 != 4 && var15 != 8 && var15 != 16 && var15 != 32) {
                  ...
                  var3 = Math.signum(this.mDx);
                  var5 = (float)this.mRecyclerView.getWidth();
                  var4 = 0.0F;
                  var3 *= var5;
               }
   ...
   public abstract static class Callback {
      ...
      public RecyclerView.ViewHolder chooseDropTarget(RecyclerView.ViewHolder var1, List var2, int var3, int var4) {
         ...
         int var5 = -1;
         int var10 = var3 - var1.itemView.getLeft();
         ...
         for(int var6 = 0; var6 < var12; ++var6) {
            ...
            int var7;
            if (var10 > 0) {
               var7 = var13.itemView.getRight() - (var3 + var8);
            ...
            if (var10 < 0) {
               var7 = var13.itemView.getLeft() - var3;
               if (var7 > 0 && var13.itemView.getLeft() < var1.itemView.getLeft()) {
                  var7 = Math.abs(var7);
                  if (var7 > var5) {
                     var5 = var7;
                     var14 = var13;
            ...
            if (var11 < 0) {
               var7 = var13.itemView.getTop() - var4;
               if (var7 > 0 && var13.itemView.getTop() < var1.itemView.getTop()) {
                  var7 = Math.abs(var7);
                  if (var7 > var5) {
                     var5 = var7;
                     var14 = var13;
            ...
            if (var11 > 0) {
               var7 = var13.itemView.getBottom() - (var4 + var9);
               if (var7 < 0 && var13.itemView.getBottom() > var1.itemView.getBottom()) {
                  var7 = Math.abs(var7);
                  if (var7 > var5) {
                     var5 = var7;
                     var14 = var13;
      ...
      void onDraw(Canvas var1, RecyclerView var2, RecyclerView.ViewHolder var3, List var4, int var5, float var6, float var7) {
         ...
         for(var8 = 0; var8 < var9; ++var8) {
            ...
            var11.update();
            int var10 = var1.save();
            this.onChildDraw(var1, var2, var11.mViewHolder, var11.field_25, var11.field_26, var11.mActionState, false);
      ...
      void onDrawOver(Canvas var1, RecyclerView var2, RecyclerView.ViewHolder var3, List var4, int var5, float var6, float var7) {
         ...
         for(var8 = 0; var8 < var9; ++var8) {
            ItemTouchHelper.RecoverAnimation var11 = (ItemTouchHelper.RecoverAnimation)var4.get(var8);
            int var10 = var1.save();
            this.onChildDrawOver(var1, var2, var11.mViewHolder, var11.field_25, var11.field_26, var11.mActionState, false);
            var1.restoreToCount(var10);
         }
   ...
   private class ItemTouchHelperGestureListener extends SimpleOnGestureListener {
      ...
      public void onLongPress(MotionEvent var1) {
         ...
         if (var5 != null) {
            RecyclerView.ViewHolder var6 = ItemTouchHelper.this.mRecyclerView.getChildViewHolder(var5);
            if (var6 != null) {
               if (ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, var6)) {
                  if (var1.getPointerId(0) == ItemTouchHelper.this.mActivePointerId) {
                     ...
                     var7.mInitialTouchX = var2;
                     var7.mInitialTouchY = var3;
                     var7.mDy = 0.0F;
                     var7.mDx = 0.0F;
                     if (var7.mCallback.isLongPressDragEnabled()) {
                        ItemTouchHelper.this.select(var6, 2);
                     }
                  }
               }
            }
   ...
   private static class RecoverAnimation implements AnimatorListener {
      ...
      public void update() {
         ...
         if (var1 == var2) {
            this.field_25 = this.mViewHolder.itemView.getTranslationX();
         } else {
            this.field_25 = var1 + this.mFraction * (var2 - var1);
         }

         var1 = this.mStartDy;
         var2 = this.mTargetY;
         if (var1 == var2) {
            this.field_26 = this.mViewHolder.itemView.getTranslationY();
         } else {
            this.field_26 = var1 + this.mFraction * (var2 - var1);
         }
      }
   }

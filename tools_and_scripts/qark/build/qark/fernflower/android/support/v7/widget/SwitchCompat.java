...
public class SwitchCompat extends CompoundButton {
   ...
   public SwitchCompat(Context var1, AttributeSet var2, int var3) {
      ...
      Drawable var7 = this.mThumbDrawable;
      if (var7 != null) {
         var7.setCallback(this);
      }

      this.mTrackDrawable = var6.getDrawable(R$styleable.SwitchCompat_track);
      var7 = this.mTrackDrawable;
      if (var7 != null) {
         var7.setCallback(this);
      }
      ...
      ColorStateList var8 = var6.getColorStateList(R$styleable.SwitchCompat_thumbTint);
      if (var8 != null) {
         this.mThumbTintList = var8;
         this.mHasThumbTint = true;
      }

      Mode var9 = DrawableUtils.parseTintMode(var6.getInt(R$styleable.SwitchCompat_thumbTintMode, -1), (Mode)null);
      if (this.mThumbTintMode != var9) {
         this.mThumbTintMode = var9;
      ...
      var8 = var6.getColorStateList(R$styleable.SwitchCompat_trackTint);
      if (var8 != null) {
         this.mTrackTintList = var8;
         this.mHasTrackTint = true;
      }

      var9 = DrawableUtils.parseTintMode(var6.getInt(R$styleable.SwitchCompat_trackTintMode, -1), (Mode)null);
      if (this.mTrackTintMode != var9) {
         this.mTrackTintMode = var9;
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.mThumbDrawable != null) {
         ...
         Drawable var8 = this.mTrackDrawable;
         if (var8 != null) {
            var8.getPadding(var7);
         } else {
            var7.setEmpty();
         }

         Rect var9 = DrawableUtils.getOpticalBounds(this.mThumbDrawable);
         var2 = Math.max(0, var9.left - var7.left);
         var3 = Math.max(0, var9.right - var7.right);
      }
      ...
      if (var2 != 16) {
         ...
         var3 = (this.getPaddingTop() + this.getHeight() - this.getPaddingBottom()) / 2;
         var2 = this.mSwitchHeight;
         var3 -= var2 / 2;
         var2 += var3;
      }

...
public class AppCompatImageHelper {
         ...
         label488: {
            ...
            try {
               if (var4.hasValue(R$styleable.AppCompatImageView_tintMode)) {
                  ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(var4.getInt(R$styleable.AppCompatImageView_tintMode, -1), (Mode)null));
               }
               break label484;
   ...
   void setInternalImageTint(ColorStateList var1) {
      if (var1 != null) {
         ...
         TintInfo var2 = this.mInternalImageTint;
         var2.mTintList = var1;
         var2.mHasTintList = true;
      } else {

...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
   ...
   public SearchView(Context var1, AttributeSet var2, int var3) {
      ...
      ViewCompat.setBackground(this.mSearchPlate, var5.getDrawable(R$styleable.SearchView_queryBackground));
      ViewCompat.setBackground(this.mSubmitArea, var5.getDrawable(R$styleable.SearchView_submitBackground));
      ...
      View var4 = this.mDropDownAnchor;
      if (var4 != null) {
   ...
   private CharSequence getDecoratedHint(CharSequence var1) {
      if (this.mIconifiedByDefault) {
         if (this.mSearchHintIcon == null) {
            ...
            double var2 = (double)this.mSearchSrcTextView.getTextSize();
            Double.isNaN(var2);
            int var4 = (int)(var2 * 1.25D);
            this.mSearchHintIcon.setBounds(0, 0, var4, var4);
            SpannableStringBuilder var5 = new SpannableStringBuilder("   ");
            var5.setSpan(new ImageSpan(this.mSearchHintIcon), 1, 2, 33);
            var5.append(var1);
            return var5;
         }
      } else {
   ...
   private void updateSearchAutoComplete() {
      ...
      if (this.mSearchable.getSuggestAuthority() != null) {
         ...
         SuggestionsAdapter var6 = (SuggestionsAdapter)this.mSuggestionsAdapter;
         byte var5 = var2;

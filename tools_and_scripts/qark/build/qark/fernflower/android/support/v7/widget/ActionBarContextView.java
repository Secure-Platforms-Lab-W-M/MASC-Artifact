   ...
   protected void onMeasure(int var1, int var2) {
      ...
      if (var3 == 1073741824) {
         if (MeasureSpec.getMode(var2) != 0) {
            ...
            View var15 = this.mClose;
            byte var7 = 0;
            var2 = var1;
            if (var15 != null) {
               var1 = this.measureChildView(var15, var1, var4, 0);
               MarginLayoutParams var16 = (MarginLayoutParams)this.mClose.getLayoutParams();
               var2 = var1 - (var16.leftMargin + var16.rightMargin);
            }
            ...
            if (var17 != null) {
               ...
               if (this.mCustomView == null) {
                  if (this.mTitleOptional) {
                     ...
                     var2 = this.measureChildView(var17, var1, var4, 0);
                  }
               }
            }

            var15 = this.mCustomView;
            if (var15 != null) {
               ...
               if (var18.width >= 0) {
                  var2 = Math.min(var18.width, var2);
               }
               ...
               if (var18.height >= 0) {
                  var5 = Math.min(var18.height, var6);
               } else {
                  var5 = var6;
               }
            ...
            var11.append(" can only be used ");
            var11.append("with android:layout_height=\"wrap_content\"");
         ...
         var11.append(this.getClass().getSimpleName());
         var11.append(" can only be used ");
         var11.append("with android:layout_width=\"match_parent\" (or fill_parent)");
         IllegalStateException var14 = new IllegalStateException(var11.toString());
         throw var14;
      }
   }

...
public class MergingPushBufferDataSource extends PushBufferDataSource {
   ...
   public MergingPushBufferDataSource(List var1) {
      this.sources = var1;
   }
   ...
   public void connect() throws IOException {
      ...
      while(var1.hasNext()) {
         ((PushBufferDataSource)var1.next()).connect();
      }
   ...
   public void disconnect() {
      ...
      while(var1.hasNext()) {
         ((PushBufferDataSource)var1.next()).disconnect();
      }
   ...
   public String getContentType() {
      for(int var1 = 0; var1 < this.sources.size(); ++var1) {
         if (!((PushBufferDataSource)this.sources.get(var1)).getContentType().equals(((PushBufferDataSource)this.sources.get(0)).getContentType())) {
   ...
   public Object getControl(String var1) {
      ...
      do {
         ...
         var3 = ((PushBufferDataSource)var2.next()).getControl(var1);
      } while(var3 == null);
   ...
   public Object[] getControls() {
      ...
      while(true) {
         ...
         Object[] var6 = ((PushBufferDataSource)var5.next()).getControls();
   ...
   public Time getDuration() {
      ...
      while(var6.hasNext()) {
         var5.add(((PushBufferDataSource)var6.next()).getDuration());
      }
   ...
   public PushBufferStream[] getStreams() {
      ...
      while(true) {
         ...
         int var1 = 0;
         if (!var3) {
            return (PushBufferStream[])var4.toArray(new PushBufferStream[0]);
         }

         PushBufferStream[] var6 = ((PushBufferDataSource)var5.next()).getStreams();
   ...
   public void start() throws IOException {
      ...
      while(var1.hasNext()) {
         ((PushBufferDataSource)var1.next()).start();
      }
   ...
   public void stop() throws IOException {
      ...
      while(var1.hasNext()) {
         ((PushBufferDataSource)var1.next()).stop();
      }

...
public class Packetizer extends AbstractPacketizer {
   ...
   public Packetizer() {
      this.outputFormats = new Format[]{new AudioFormat("ULAW/rtp", -1.0D, 8, 1, -1, -1, 8, -1.0D, Format.byteArray)};
   ...
   public Format[] getSupportedOutputFormats(Format var1) {
      if (var1 == null) {
         ...
         if (!(var1 instanceof AudioFormat)) {
            ...
            if (!var2.getEncoding().equals("ULAW") || var2.getSampleSizeInBits() != 8 && var2.getSampleSizeInBits() != -1 || var2.getChannels() != 1 && var2.getChannels() != -1 || var2.getFrameSizeInBits() != 8 && var2.getFrameSizeInBits() != -1) {
               var4 = logger;
               var3 = new StringBuilder();
               var3.append(this.getClass().getSimpleName());
               var3.append(".getSupportedOutputFormats: input format does not match, returning format array of {null} for ");
               ...
               return new Format[]{new AudioFormat("ULAW/rtp", var2.getSampleRate(), 8, 1, var2.getEndian(), var2.getSigned(), 8, var2.getFrameRate(), var2.getDataType())};
            }
         }
      }
   }
   ...
   public void open() {
      this.setPacketSize((int)((AudioFormat)this.getInputFormat()).getSampleRate() / 50);
   }

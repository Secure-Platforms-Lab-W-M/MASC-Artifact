...
public class DePacketizer extends AbstractDePacketizer {
   ...
   public DePacketizer() {
      this.outputFormats = new Format[]{new AudioFormat("ULAW", -1.0D, -1, -1, -1, -1, -1, -1.0D, Format.byteArray)};
      this.inputFormats = new Format[]{new AudioFormat("ULAW/rtp", -1.0D, -1, -1, -1, -1, -1, -1.0D, Format.byteArray)};
   }
   ...
   public Format[] getSupportedOutputFormats(Format var1) {
      if (var1 == null) {
         ...
         if (!(var1 instanceof AudioFormat)) {
            ...
            if (!var2.getEncoding().equals("ULAW/rtp")) {
               var4 = logger;
               var3 = new StringBuilder();
               var3.append(this.getClass().getSimpleName());
               var3.append(".getSupportedOutputFormats: input format does not match, returning format array of {null} for ");
               ...
               return new Format[]{new AudioFormat("ULAW", var2.getSampleRate(), var2.getSampleSizeInBits(), var2.getChannels(), var2.getEndian(), var2.getSigned(), var2.getFrameSizeInBits(), var2.getFrameRate(), var2.getDataType())};
            }
         }
      }
   }

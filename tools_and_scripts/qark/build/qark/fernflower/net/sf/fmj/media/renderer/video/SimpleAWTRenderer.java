...
public class SimpleAWTRenderer extends AbstractVideoRenderer implements VideoRenderer {
   ...
   private SimpleAWTRenderer.AwtVideoComponent component;
   ...
   public SimpleAWTRenderer() {
      ...
      this.component = new SimpleAWTRenderer.AwtVideoComponent();
   ...
   private class AwtVideoComponent extends Component {
      ...
      private Rectangle getVideoRect(boolean var1) {
         ...
         if (!var1) {
            ...
            if ((float)var7.width / (float)var6.width < (float)var7.height / (float)var6.height) {
               var5 = var7.width;

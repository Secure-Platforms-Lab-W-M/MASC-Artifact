...
public class MergingPullDataSource extends PullDataSource {
   ...
   public MergingPullDataSource(List var1) {
      this.sources = var1;
   }
   ...
   public void connect() throws IOException {
      ...
      while(var1.hasNext()) {
         ((PullDataSource)var1.next()).connect();
      }
   ...
   public void disconnect() {
      ...
      while(var1.hasNext()) {
         ((PullDataSource)var1.next()).disconnect();
      }
   ...
   public String getContentType() {
      for(int var1 = 0; var1 < this.sources.size(); ++var1) {
         if (!((PullDataSource)this.sources.get(var1)).getContentType().equals(((PullDataSource)this.sources.get(0)).getContentType())) {
   ...
   public Object getControl(String var1) {
      ...
      do {
         ...
         var3 = ((PullDataSource)var2.next()).getControl(var1);
      } while(var3 == null);
   ...
   public Object[] getControls() {
      ...
      while(true) {
         ...
         Object[] var6 = ((PullDataSource)var5.next()).getControls();
   ...
   public Time getDuration() {
      ...
      while(var6.hasNext()) {
         var5.add(((PullDataSource)var6.next()).getDuration());
      }
   ...
   public PullSourceStream[] getStreams() {
      ...
      while(true) {
         ...
         int var1 = 0;
         if (!var3) {
            return (PullSourceStream[])var4.toArray(new PullSourceStream[0]);
         }

         PullSourceStream[] var6 = ((PullDataSource)var5.next()).getStreams();
   ...
   public void start() throws IOException {
      ...
      while(var1.hasNext()) {
         ((PullDataSource)var1.next()).start();
      }

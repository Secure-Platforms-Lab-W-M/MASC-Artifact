...
public final class TextViewCompat
{
    ...
    static class TextViewCompatBaseImpl
    {
        ...
        public int getMaxLines(final TextView textView) {
            ...
            final Field sMaxModeField = TextViewCompatBaseImpl.sMaxModeField;
            if (sMaxModeField != null && retrieveIntFromField(sMaxModeField, textView) == 1) {
                ...
                final Field sMaximumField = TextViewCompatBaseImpl.sMaximumField;
        ...
        public int getMinLines(final TextView textView) {
            ...
            final Field sMinModeField = TextViewCompatBaseImpl.sMinModeField;
            if (sMinModeField != null && retrieveIntFromField(sMinModeField, textView) == 1) {
                ...
                final Field sMinimumField = TextViewCompatBaseImpl.sMinimumField;

...
public class ConstraintSet
{
    ...
    private static int lookupID(final TypedArray typedArray, final int n, int resourceId) {
    ...
    public void center(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final float horizontalBias) {
        if (n4 < 0) {
        ...
        if (n3 != 6 && n3 != 7) {
            ...
            this.mConstraints.get(n).verticalBias = horizontalBias;
            return;
        }
    ...
    public void connect(final int n, final int n2, final int leftToRight, final int n3) {
        if (!this.mConstraints.containsKey(n)) {
            this.mConstraints.put(n, new Constraint());
        }
        final Constraint constraint = this.mConstraints.get(n);
        switch (n2) {
            default: {
                ...
                sb.append(" to ");
                sb.append(this.sideToString(n3));
                sb.append(" unknown");
            ...
            case 7: {
                ...
                final StringBuilder sb2 = new StringBuilder();
                sb2.append("right to ");
                sb2.append(this.sideToString(n3));
            ...
            case 6: {
                ...
                sb3.append("right to ");
                sb3.append(this.sideToString(n3));
            ...
            case 5: {
                ...
                sb4.append("right to ");
                sb4.append(this.sideToString(n3));
            ...
            case 4: {
                ...
                sb5.append("right to ");
                sb5.append(this.sideToString(n3));
            ...
            case 3: {
                ...
                sb6.append("right to ");
                sb6.append(this.sideToString(n3));
            ...
            case 2: {
                ...
                sb7.append("right to ");
                sb7.append(this.sideToString(n3));
            ...
            case 1: {
                ...
                sb8.append("left to ");
                sb8.append(this.sideToString(n3));
    ...
    public void connect(final int n, final int n2, final int leftToRight, final int n3, final int n4) {
        if (!this.mConstraints.containsKey(n)) {
            this.mConstraints.put(n, new Constraint());
        }
        final Constraint constraint = this.mConstraints.get(n);
                            ...
                            while (true) {
                                Label_0111: {
                                    try {
                                        ...
                                        break Label_0111;
                                        // iftrue(Label_0150:, !name.equalsIgnoreCase("Guideline"))
                                        while (true) {

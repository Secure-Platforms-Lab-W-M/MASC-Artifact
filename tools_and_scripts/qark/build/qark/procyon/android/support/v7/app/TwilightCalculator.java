...
class TwilightCalculator
{
    ...
    public void calculateTwilight(final long n, double n2, double n3) {
        ...
        Double.isNaN(n6);
        final double n7 = 1.796593063 + (n6 + sin * 0.03341960161924362 + Math.sin(2.0f * n5) * 3.4906598739326E-4 + Math.sin(3.0f * n5) * 5.236000106378924E-6) + 3.141592653589793;
        n3 = -n3 / 360.0;
        final double n8 = n4 - 9.0E-4f;
        Double.isNaN(n8);
        final double n9 = 9.0E-4f + Math.round(n8 - n3);
        Double.isNaN(n9);
        n3 = n9 + n3 + Math.sin(n5) * 0.0053 + Math.sin(2.0 * n7) * -0.0069;
        ...
        final float n10 = (float)(Math.acos(n2) / 6.283185307179586);
        n2 = n10;
        Double.isNaN(n2);
        this.sunset = Math.round((n2 + n3) * 8.64E7) + 946728000000L;
        n2 = n10;
        Double.isNaN(n2);
        this.sunrise = Math.round((n3 - n2) * 8.64E7) + 946728000000L;

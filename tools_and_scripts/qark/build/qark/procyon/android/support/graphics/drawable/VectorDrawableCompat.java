...
public class VectorDrawableCompat extends VectorDrawableCommon
{
    ...
    private void inflateInternal(final Resources resources, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) throws XmlPullParserException, IOException {
        ...
        for (int n2 = xmlPullParser.getEventType(), depth = xmlPullParser.getDepth(); n2 != 1 && (xmlPullParser.getDepth() >= depth + 1 || n2 != 3); n2 = xmlPullParser.next()) {
            int n3 = 0;
            Label_0384: {
                if (n2 == 2) {
    ...
    private boolean needMirroring() {
        return Build$VERSION.SDK_INT >= 17 && (this.isAutoMirrored() && DrawableCompat.getLayoutDirection(this) == 1);
    }

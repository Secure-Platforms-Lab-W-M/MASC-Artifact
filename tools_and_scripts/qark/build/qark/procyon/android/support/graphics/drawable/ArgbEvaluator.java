...
public class ArgbEvaluator implements TypeEvaluator
{
    ...
    public Object evaluate(final float n, final Object o, final Object o2) {
        ...
        return Math.round(((n6 - n2) * n + n2) * 255.0f) << 24 | Math.round((float)Math.pow(((float)Math.pow(n7, 2.2) - n10) * n + n10, 0.45454545454545453) * 255.0f) << 16 | Math.round((float)Math.pow(((float)Math.pow(n8, 2.2) - n11) * n + n11, 0.45454545454545453) * 255.0f) << 8 | Math.round((float)Math.pow(((float)Math.pow(n9, 2.2) - n12) * n + n12, 0.45454545454545453) * 255.0f);
    }
}

            ...
            this.mListener = (Window$OnFrameMetricsAvailableListener)new Window$OnFrameMetricsAvailableListener() {
                public void onFrameMetricsAvailable(final Window window, final FrameMetrics frameMetrics, final int n) {
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x1) != 0x0) {
                        final FrameMetricsApi24Impl this$0 = FrameMetricsApi24Impl.this;
                        this$0.addDurationItem(this$0.mMetrics[0], frameMetrics.getMetric(8));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x2) != 0x0) {
                        final FrameMetricsApi24Impl this$2 = FrameMetricsApi24Impl.this;
                        this$2.addDurationItem(this$2.mMetrics[1], frameMetrics.getMetric(1));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x4) != 0x0) {
                        final FrameMetricsApi24Impl this$3 = FrameMetricsApi24Impl.this;
                        this$3.addDurationItem(this$3.mMetrics[2], frameMetrics.getMetric(3));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x8) != 0x0) {
                        final FrameMetricsApi24Impl this$4 = FrameMetricsApi24Impl.this;
                        this$4.addDurationItem(this$4.mMetrics[3], frameMetrics.getMetric(4));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x10) != 0x0) {
                        final FrameMetricsApi24Impl this$5 = FrameMetricsApi24Impl.this;
                        this$5.addDurationItem(this$5.mMetrics[4], frameMetrics.getMetric(5));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x40) != 0x0) {
                        final FrameMetricsApi24Impl this$6 = FrameMetricsApi24Impl.this;
                        this$6.addDurationItem(this$6.mMetrics[6], frameMetrics.getMetric(7));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x20) != 0x0) {
                        final FrameMetricsApi24Impl this$7 = FrameMetricsApi24Impl.this;
                        this$7.addDurationItem(this$7.mMetrics[5], frameMetrics.getMetric(6));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x80) != 0x0) {
                        final FrameMetricsApi24Impl this$8 = FrameMetricsApi24Impl.this;
                        this$8.addDurationItem(this$8.mMetrics[7], frameMetrics.getMetric(0));
                    }
                    if ((FrameMetricsApi24Impl.this.mTrackingFlags & 0x100) != 0x0) {
                        final FrameMetricsApi24Impl this$9 = FrameMetricsApi24Impl.this;
                        this$9.addDurationItem(this$9.mMetrics[8], frameMetrics.getMetric(2));
                    }
                }
            };
